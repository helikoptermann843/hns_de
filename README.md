...
**`hns_de`** hierbei handelt es sich um eine Basis für deutsche Romhacks, aufbauend auf pokeemerald-expansion Es lässt sich daraus aktuell Pokémon Heart&Soul (Johto) bauen. Das gesamte Archiv wurde anhand deutscher Roms und viel Handarbeit komplett auf deutsch übersetzt. Es lässt sich auch gut als Grundlage für andere Roms verwenden, weil z.B. Smaragd-Maps und deren Storytexte enthalten sind.
