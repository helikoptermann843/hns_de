...
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_TEAM1} wird in\nWEISSNEBEL gehüllt!");
const u8 gText_PkmnGettingPumped[] = _("{B_DEF_NAME_WITH_PREFIX} pumpt\nsich auf!");
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_BUFF1} von\n{B_LAST_ABILITY} verhindert\pWechsel!\p");
const u8 gText_StatSharply[] = _("stark ");
const u8 gText_StatRose[] = _("steigt.");
const u8 gText_StatFell[] = _("sinkt!");
const u8 gText_DefendersStatRose[] = _("{B_DEF_NAME_WITH_PREFIX} von\n{B_BUFF1} {B_BUFF2}");
...
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("Patt zwischen Spieler, {B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}Ù {B_LINK_OPPONENT1_NAME} flieht!"); //not in gen 5+, replaced with match was forfeited text
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}Ù {B_LINK_OPPONENT1_NAME} und\n{B_LINK_OPPONENT2_NAME} fliehen!"); //not in gen 5+, replaced with match was forfeited text
...
static const u8 sText_TwoWildPkmnAppeared[] = _("Ein wildes {B_OPPONENT_MON1_NAME} und\nein wildes {B_OPPONENT_MON2_NAME} erscheinen!\p");
static const u8 sText_GhostAppearedCantId[] = _("Ein Geist erscheint!\pDarn!\nKann nicht identizifiert werden!\p");
...
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} wird von\n{B_OPPONENT_MON1_NAME}  in den\lKampf geschickt!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} und {B_OPPONENT_MON1_NAME}\nwerden von\p{B_OPPONENT_MON2_NAME} \nin den Kampf geschickt!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_NAME_WITH_CLASS} wird von\n{B_BUFF1}  in den\lKampf geschickt!");
...
static const u8 sText_Trainer1WithdrewPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} wurde\nvon {B_BUFF1} \lzurückgerufen!");
...
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_NAME_WITH_CLASS} {B_TRAINER2_NAME_WITH_CLASS}\nund  \lsind besiegt!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNMADESLEEP]                        = COMPOUND_STRING("{B_SCR_ABILITY} von\n{B_SCR_NAME_WITH_PREFIX} lässt\l{B_EFF_NAME_WITH_PREFIX} einschlafen!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPOISONEDBY]                       = COMPOUND_STRING("{B_SCR_ABILITY} von\n{B_SCR_NAME_WITH_PREFIX} vergiftete\l{B_EFF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNBURNEDBY]                         = COMPOUND_STRING("{B_SCR_ABILITY} von\n{B_SCR_NAME_WITH_PREFIX} verbrennt\l{B_EFF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNFROZENBY]                         = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} wurde durch\n{B_SCR_ABILITY} von\l{B_SCR_NAME_WITH_PREFIX} eingefroren!"), //not in gen 5+, ability popup
    [STRINGID_PKMNISFROZEN]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ist\neingefroren!"),
    [STRINGID_PKMNWASDEFROSTED]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wurde\naufgetaut!"),
    [STRINGID_PKMNWASDEFROSTEDBY]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde\ndurch {B_CURRENT_MOVE} aufgetaut!"),
    [STRINGID_PKMNWASPARALYZED]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} ist\nparalysiert! Es greift\leventuell nicht an!"),
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("{B_SCR_ABILITY} von\n{B_SCR_NAME_WITH_PREFIX} paralysierte\p{B_EFF_NAME_WITH_PREFIX}!\nEs greift eventuell nicht an!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNUSEDSAFEGUARD]                    = COMPOUND_STRING("Team von {B_DEF_NAME_WITH_PREFIX}\nwird durch BODYGUARD geschützt!"),
    ...
    [STRINGID_PKMNWOKEUPINUPROAR]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wird durch\nAUFRUHR wach!"),
    ...
    [STRINGID_PKMNFATIGUECONFUSION]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ist vor\nErschöpfung verwirrt!"),
    ...
    [STRINGID_PKMNMOVEDISABLEDNOMORE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ist nicht\nmehr blockiert!"),
    ...
    [STRINGID_PKMNENCOREENDED]                      = COMPOUND_STRING("ZUGABE von {B_ATK_NAME_WITH_PREFIX}\nist beendet!"),
    ...
    [STRINGID_PKMNCOPIEDSTATCHANGES]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} kopiert die\nStatusveränderungen\lvon {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNGOTFREE]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} befreit\nsich von {B_BUFF1}\lvon {B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_PKMNBLEWAWAYSPIKES]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bläst den\nSTACHLER weg!"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_PKMNCENTERATTENTION]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} zieht alle\nAufmerksamkeit auf sich!"),
    ...
    [STRINGID_PKMNRESTOREDHPUSING]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} füllt KP mit\nHilfe von {B_DEF_ABILITY} auf!"), //not in gen 5+, ability popup
    [STRINGID_PKMNCHANGEDTYPEWITH]                  = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} macht es zu\leinem {B_BUFF1}-Typ!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPREVENTSCONFUSIONWITH]            = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} verhindert\lVerwirrung!"), //not in gen 5+, ability popup
    [STRINGID_PKMNRAISEDFIREPOWERWITH]              = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} erhöht die\lFEUER-Kraft!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("{B_SCR_ABILITY} von\n{B_SCR_NAME_WITH_PREFIX} vermindert\lANGRIFF von {B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNHURTSWITH]                        = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} verletzt\l{B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_SCRIPTINGSTATROSE]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}steigt an!"),
    ...
    [STRINGID_GIVENICKNAMECAPTURED]                 = COMPOUND_STRING("Möchtest du dem {B_OPPONENT_MON1_NAME}\neinen Spitznamen geben?"),
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("Für {B_OPPONENT_MON1_NAME} wurde ein Eintrag\nim POKéDEX angelegt.\p"),
    ...
    [STRINGID_PKMNSXINFATUATEDY]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ist vernarrt\nin {B_DEF_ABILITY} von\l{B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXMADEYINEFFECTIVE]               = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} macht\l{B_CURRENT_MOVE} wirkungslos!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXMADEYUSELESS]                   = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} hebt die\lWirkung von {B_CURRENT_MOVE} auf!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNAVOIDEDATTACK]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wehrt die\nAttacke ab!"),
	...
	[STRINGID_GRAVITYINTENSIFIED]                   = COMPOUND_STRING("Die Schwerkraft verstärkte sich!"),
	[STRINGID_TARGETWOKEUP]                         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ist aufgewacht!"),
	[STRINGID_TAILWINDBLEW]                         = COMPOUND_STRING("Der Rückenwind wehte hinter {B_ATK_TEAM2}-Team!"),
	...
	[STRINGID_SHIELDEDFROMCRITICALHITS]             = COMPOUND_STRING("Glücksschild schützte {B_ATK_TEAM2}-Team vor kritischen Treffern!"),
	[STRINGID_PKMNACQUIREDABILITY]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} erhielt {B_DEF_ABILITY}!"),
	[STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("Giftspitzen wurden rund um {B_DEF_TEAM2}-Team gestreut!"),
	...
	[STRINGID_POINTEDSTONESFLOAT]                   = COMPOUND_STRING("Spitze Steine schwebten um {B_DEF_TEAM2}-Team!"),
	...
	[STRINGID_SWAPSDEFANDSPDEFOFALLPOKEMON]         = COMPOUND_STRING("Es wurde ein seltsames Gebiet erschaffen, in dem Verteidigungs- und Spezial-Verteidigungswerte vertauscht sind!"),
	...
	[STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("Es wurde ein seltsames Gebiet erschaffen, in dem die Effekte von gehaltenen Items verloren gehen!"),
	...
	[STRINGID_ALLYSWITCHPOSITION]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} und {B_SCR_NAME_WITH_PREFIX2} haben die Plätze getauscht!"),
	[STRINGID_REFLECTTARGETSTYPE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde vom gleichen Typ wie {B_DEF_NAME_WITH_PREFIX2}!"),
	...
	[STRINGID_BUFFERENDS]                           = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}s {B_BUFF1} ließ nach!"),
	[STRINGID_TELEKINESISENDS]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde von Telekinese befreit!"),
	[STRINGID_TAILWINDENDS]                         = COMPOUND_STRING("Der Rückenwind des Teams {B_ATK_TEAM1} ließ nach!"),
	[STRINGID_LUCKYCHANTENDS]                       = COMPOUND_STRING("Der Glücks-Spruch des Teams {B_ATK_TEAM1} endete!"),
	[STRINGID_TRICKROOMENDS]                        = COMPOUND_STRING("Die verdrehten Dimensionen kehrten zur Normalität zurück!"),
	[STRINGID_WONDERROOMENDS]                       = COMPOUND_STRING("Der Wunderraum endete, Verteidigung und Spezial-Verteidigung wurden normal!"),
	[STRINGID_MAGICROOMENDS]                        = COMPOUND_STRING("Der Magieraum endete, die Effekte von Items wurden wiederhergestellt!"),
	[STRINGID_MUDSPORTENDS]                         = COMPOUND_STRING("Die Effekte von Schlammwetter haben nachgelassen."),
	[STRINGID_WATERSPORTENDS]                       = COMPOUND_STRING("Die Effekte von Wasserwetter haben nachgelassen."),
	...
	[STRINGID_ELECTRICTERRAINENDS]                  = COMPOUND_STRING("Die Elektrizität verschwand vom Kampfplatz."),
	[STRINGID_MISTYTERRAINENDS]                     = COMPOUND_STRING("Der Nebel verschwand vom Kampfplatz."),
	[STRINGID_PSYCHICTERRAINENDS]                   = COMPOUND_STRING("Die seltsame Kraft auf dem Kampfplatz verschwand!"),
	[STRINGID_GRASSYTERRAINENDS]                    = COMPOUND_STRING("Das Gras auf dem Kampfplatz verschwand."),
	[STRINGID_TARGETABILITYSTATRAISE]               = COMPOUND_STRING("Die Fähigkeit {B_DEF_ABILITY} von {B_DEF_NAME_WITH_PREFIX} erhöhte {B_BUFF1}!"),
	...
	[STRINGID_ATTACKERABILITYSTATRAISE]             = COMPOUND_STRING("Die Fähigkeit {B_SCR_ABILITY} von {B_SCR_NAME_WITH_PREFIX} erhöhte {B_BUFF1}!"),
	...
	[STRINGID_TERAVOLTENTERS]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} strahlt eine kraftvolle Aura aus!"),
	[STRINGID_TURBOBLAZEENTERS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} strahlt eine brennende Aura aus!"),
	[STRINGID_SLOWSTARTENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} kommt nur langsam in Fahrt!"),
	[STRINGID_SLOWSTARTEND]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hat endlich Fahrt aufgenommen!"),
	[STRINGID_SOLARPOWERHPDROP]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}s {B_ATK_ABILITY} fordert seinen Tribut!"),
	...
	[STRINGID_FRISKACTIVATES]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} durchsuchte {B_DEF_NAME_WITH_PREFIX2} und fand das {B_LAST_ITEM}!"),
	[STRINGID_UNNERVEENTERS]                        = COMPOUND_STRING("Das Team {B_EFF_TEAM1} ist zu nervös, um Beeren zu essen!"),
	...
	[STRINGID_TOXICSPIKESABSORBED]                  = COMPOUND_STRING("Die Giftspitzen rund um {B_EFF_TEAM2}-Team verschwanden!"),
	...
	[STRINGID_STICKYWEBSWITCHIN]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} wurde im Klebenetz gefangen!"),
	[STRINGID_HEALINGWISHCAMETRUE]                  = COMPOUND_STRING("Der Heilungswunsch ging für {B_ATK_NAME_WITH_PREFIX2} in Erfüllung!"),
	[STRINGID_HEALINGWISHHEALED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} erhielt wieder HP!"),
	[STRINGID_LUNARDANCECAMETRUE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hüllte sich in mystisches Mondlicht!"),
	...
	[STRINGID_TARGETABILITYSTATLOWER]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}s {B_DEF_ABILITY} senkte {B_BUFF1}!"),
	...
	[STRINGID_ASSAULTVESTDOESNTALLOW]               = COMPOUND_STRING("Die Effekte des {B_LAST_ITEM} verhindern den Einsatz von Status-Attacken!\p"),
	...
	[STRINGID_STICKYWEBUSED]                        = COMPOUND_STRING("Ein Klebenetz wurde rund um {B_DEF_TEAM2}-Team gelegt!"),
	[STRINGID_QUASHSUCCESS]                         = COMPOUND_STRING("Die Aktion von {B_DEF_NAME_WITH_PREFIX} wurde verschoben!"),
	[STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blies Giftspitzen weg!"),
	[STRINGID_PKMNBLEWAWAYSTICKYWEB]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blies das Klebenetz weg!"),
	[STRINGID_PKMNBLEWAWAYSTEALTHROCK]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blies Tarnsteine weg!"),
	[STRINGID_IONDELUGEON]                          = COMPOUND_STRING("Ein Ionenregen überschwemmte den Kampfplatz!"),
	[STRINGID_TOPSYTURVYSWITCHEDSTATS]              = COMPOUND_STRING("Alle Statusänderungen von {B_DEF_NAME_WITH_PREFIX2} wurden umgekehrt!"),
	[STRINGID_TERRAINBECOMESMISTY]                  = COMPOUND_STRING("Nebel wirbelte über den Kampfplatz!"),
	[STRINGID_TERRAINBECOMESGRASSY]                 = COMPOUND_STRING("Gras wuchs über den Kampfplatz!"),
	[STRINGID_TERRAINBECOMESELECTRIC]               = COMPOUND_STRING("Ein elektrischer Strom durchzog den Kampfplatz!"),
	[STRINGID_TERRAINBECOMESPSYCHIC]                = COMPOUND_STRING("Der Kampfplatz wurde seltsam!"),
	[STRINGID_TARGETELECTRIFIED]                    = COMPOUND_STRING("Die Attacken von {B_DEF_NAME_WITH_PREFIX} wurden elektrifiziert!"),
	[STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}s {B_LAST_ITEM} reagiert auf den Mega-Ring von {B_ATK_TRAINER_NAME}!"),
	...
	[STRINGID_BURSTINGFLAMESHIT]                    = COMPOUND_STRING("Die explodierenden Flammen trafen {B_SCR_NAME_WITH_PREFIX2}!"),
	...
	[STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("Wenn die Flamme das Pulver berührt, explodiert es!"),
	[STRINGID_BELCHCANTSELECT]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hat keine Beere gegessen, daher kann es nicht rülpsen!\p"),
	...
	[STRINGID_MISTYTERRAINPREVENTS]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hüllt sich in schützenden Nebel!"),
	[STRINGID_GRASSYTERRAINHEALS]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wird durch das Grasfeld geheilt!"),
	[STRINGID_ELECTRICTERRAINPREVENTS]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hüllt sich in elektrifiziertes Terrain!"),
	[STRINGID_PSYCHICTERRAINPREVENTS]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wird durch Psychoterrain geschützt!"),
	[STRINGID_SAFETYGOGGLESPROTECTED]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ist dank {B_LAST_ITEM} geschützt!"),
	[STRINGID_FLOWERVEILPROTECTED]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hüllte sich in einen Blütenschleier!"),
	[STRINGID_AROMAVEILPROTECTED]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wird durch einen aromatischen Schleier geschützt!"),
	...
	[STRINGID_PKMNCANTUSEMOVETHROATCHOP]            = COMPOUND_STRING("Die Effekte von Halsabschneider verhindern, dass {B_ATK_NAME_WITH_PREFIX2} bestimmte Attacken einsetzt!\p"),
	[STRINGID_LASERFOCUS]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} konzentrierte sich intensiv!"),
	[STRINGID_GEMACTIVATES]                         = COMPOUND_STRING("{B_LAST_ITEM} verstärkte die Kraft von {B_ATK_NAME_WITH_PREFIX2}!"),
	[STRINGID_BERRYDMGREDUCES]                      = COMPOUND_STRING("{B_LAST_ITEM} reduzierte den Schaden für {B_SCR_NAME_WITH_PREFIX2}!"),
	...
	[STRINGID_ILLUSIONWOREOFF]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}s Illusion löste sich auf!"),
	[STRINGID_ATTACKERCUREDTARGETSTATUS]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} heilte das Problem von {B_DEF_NAME_WITH_PREFIX2}!"),
	[STRINGID_ATTACKERLOSTFIRETYPE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} brannte sich selbst aus!"),
	[STRINGID_HEALERCURE]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}s {B_LAST_ABILITY} heilte {B_SCR_NAME_WITH_PREFIX2}s Problem!"),
	[STRINGID_SCRIPTINGABILITYSTATRAISE]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}s {B_SCR_ABILITY} erhöhte {B_BUFF1}!"),
	...
	[STRINGID_NOONEWILLBEABLETORUNAWAY]             = COMPOUND_STRING("Keiner kann sich in der nächsten Runde zurückziehen!"),
	[STRINGID_DESTINYKNOTACTIVATES]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} verliebte sich wegen {B_LAST_ITEM}!"),
	[STRINGID_CLOAKEDINAFREEZINGLIGHT]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hüllte sich in eisiges Licht!"),
	[STRINGID_CLEARAMULETWONTLOWERSTATS]            = COMPOUND_STRING("Die Effekte von {B_LAST_ITEM} verhindern, dass {B_SCR_NAME_WITH_PREFIX2}s Statuswerte gesenkt werden!"),
	...
	[STRINGID_COMATOSEENTERS]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} schläft fast ein!"),
	...
	[STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Beide Pokémon werden in drei Runden besiegt sein!"),
	...
	[STRINGID_CANACTFASTERTHANKSTO]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} kann schneller handeln dank {B_BUFF1}!"),
	...
	[STRINGID_REDCARDACTIVATE]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} hielt seine Rote Karte gegen {B_ATK_NAME_WITH_PREFIX2} hoch!"),
	[STRINGID_EJECTBUTTONACTIVATE]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} wird mit {B_LAST_ITEM} ausgewechselt!"),
	...
	[STRINGID_ATTACKERBECAMEFULLYCHARGED]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde durch die Bindung zu seinem Trainer vollständig aufgeladen!\p"),
	...
	[STRINGID_EXTREMESUNLIGHTFADED]                 = COMPOUND_STRING("Das extrem grelle Sonnenlicht ließ nach!"),
	[STRINGID_MOVEEVAPORATEDINTHEHARSHSUNLIGHT]     = COMPOUND_STRING("Die Wasser-Attacke verdampfte im extrem grellen Sonnenlicht!"),
	[STRINGID_EXTREMELYHARSHSUNLIGHTWASNOTLESSENED] = COMPOUND_STRING("Das extrem grelle Sonnenlicht wurde überhaupt nicht abgeschwächt!"),
	[STRINGID_HEAVYRAIN]                            = COMPOUND_STRING("Starker Regen begann zu fallen!"),
	[STRINGID_HEAVYRAINLIFTED]                      = COMPOUND_STRING("Der starke Regen hörte auf!"),
	[STRINGID_MOVEFIZZLEDOUTINTHEHEAVYRAIN]         = COMPOUND_STRING("Die Feuer-Attacke verlosch im starken Regen!"),
	[STRINGID_NORELIEFROMHEAVYRAIN]                 = COMPOUND_STRING("Es gibt keine Erleichterung vor dem starken Regen!"),
	[STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Seltsame starke Winde schützen Flug-Pokémon!"),
	[STRINGID_STRONGWINDSDISSIPATED]                = COMPOUND_STRING("Die seltsamen starken Winde haben sich aufgelöst!"),
	[STRINGID_MYSTERIOUSAIRCURRENTBLOWSON]          = COMPOUND_STRING("Die seltsamen starken Winde wehen weiterhin!"),
	[STRINGID_ATTACKWEAKENEDBSTRONGWINDS]           = COMPOUND_STRING("Die seltsamen starken Winde schwächten die Attacke!"),
	[STRINGID_STUFFCHEEKSCANTSELECT]                = COMPOUND_STRING("Es kann die Attacke nicht einsetzen, da keine Beere vorhanden ist!\p"),
	[STRINGID_PKMNREVERTEDTOPRIMAL]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}s Urform-Reversion! Es kehrte in seinen Urzustand zurück!"),
	[STRINGID_BUTPOKEMONCANTUSETHEMOVE]             = COMPOUND_STRING("Aber {B_ATK_NAME_WITH_PREFIX2} kann die Attacke nicht einsetzen!"),
	[STRINGID_BUTHOOPACANTUSEIT]                    = COMPOUND_STRING("Aber {B_ATK_NAME_WITH_PREFIX2} kann sie momentan nicht einsetzen!"),
	...
	[STRINGID_BOTHCANNOLONGERESCAPE]                = COMPOUND_STRING("Keines der Pokémon kann sich zurückziehen!"),
	...
	[STRINGID_NEUTRALIZINGGASENTERS]                = COMPOUND_STRING("Neutralisierende Gas füllte das Feld!"),
	[STRINGID_NEUTRALIZINGGASOVER]                  = COMPOUND_STRING("Die Effekte des neutralisierenden Gases endeten!"),
	[STRINGID_TARGETTOOHEAVY]                       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ist zu schwer, um gehoben zu werden!"),
	[STRINGID_PKMNTOOKTARGETHIGH]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} nahm {B_DEF_NAME_WITH_PREFIX2} in die Luft!"),
	[STRINGID_PKMNINSNAPTRAP]                       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wurde in einer Schlingfalle gefangen!"),
	[STRINGID_METEORBEAMCHARGING]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sammelt die Kraft des Raums!"),
	[STRINGID_HEATUPBEAK]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} erhitzte seinen Schnabel!"),
	[STRINGID_COURTCHANGE]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} tauschte die Effekte auf beiden Seiten des Feldes!"),
	[STRINGID_ZPOWERSURROUNDS]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hüllte sich in seine Z-Kraft!"),
	[STRINGID_ZMOVEUNLEASHED]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} setzt seine volle Z-Move-Kraft frei!"),
	[STRINGID_ZMOVERESETSSTATS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} stellte seine gesenkten Statuswerte mit Z-Kraft wieder her!"),
	[STRINGID_ZMOVEALLSTATSUP]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} steigerte seine Statuswerte mit Z-Kraft!"),
	[STRINGID_ZMOVEZBOOSTCRIT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} steigerte seine Krit-Quote mit Z-Kraft!"),
	...
	[STRINGID_ATTACKEREXPELLEDTHEPOISON]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hat das Gift abgewehrt, damit du dir keine Sorgen machst!"),
	...
	[STRINGID_ATTACKERBROKETHROUGHPARALYSIS]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sammelte all seine Energie, um die Lähmung zu überwinden, damit du dir keine Sorgen machst!"),
	[STRINGID_ATTACKERHEALEDITSBURN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} heilte seine Verbrennung durch reinen Willen, damit du dir keine Sorgen machst!"),
	[STRINGID_ATTACKERMELTEDTHEICE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} schmolz das Eis mit feurigem Willen, damit du dir keine Sorgen machst!"),
	[STRINGID_TARGETTOUGHEDITOUT]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hielt durch, damit du nicht traurig bist!"),
	[STRINGID_ATTACKERLOSTELECTRICTYPE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} verbrauchte seine gesamte Elektrizität!"),
	...
	[STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}s {B_SCR_ABILITY} schwächte {B_BUFF1} aller umgebenden Pokémon!\p"),
	[STRINGID_ATTACKERGAINEDSTRENGTHFROMTHEFALLEN]  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} gewann Stärke von den Gefallenen!"),
	...
	[STRINGID_PREPARESHELLTRAP]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} legte eine Schalenfalle!"),
	[STRINGID_SHELLTRAPDIDNTWORK]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}s Schalenfalle funktionierte nicht!"),
	[STRINGID_SPIKESDISAPPEAREDFROMTEAM]            = COMPOUND_STRING("Die Stacheln verschwanden vom Boden um {B_ATK_TEAM2} Team!"),
	[STRINGID_TOXICSPIKESDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("Die Giftschichten verschwanden vom Boden um {B_ATK_TEAM2} Team!"),
	[STRINGID_STICKYWEBDISAPPEAREDFROMTEAM]         = COMPOUND_STRING("Das klebrige Netz verschwand vom Boden um {B_ATK_TEAM2} Team!"),
	[STRINGID_STEALTHROCKDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("Die spitzen Steine verschwanden um {B_ATK_TEAM2} Team!"),
	...
	[STRINGID_PKMNREVIVEDREADYTOFIGHT]              = COMPOUND_STRING("{B_BUFF1} wurde wiederbelebt und ist bereit zum Kämpfen!"),
	...
	[STRINGID_ITEMRESTOREDSPECIESPP]                = COMPOUND_STRING("{B_BUFF1}s PP wurden wiederhergestellt!"),
	...
	[STRINGID_PKMNITEMMELTED]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} zersetzte {B_DEF_NAME_WITH_PREFIX2}s {B_LAST_ITEM}!"),
	[STRINGID_ULTRABURSTREACTING]                   = COMPOUND_STRING("Helles Licht bricht gleich aus {B_ATK_NAME_WITH_PREFIX2}!"),
	[STRINGID_ULTRABURSTCOMPLETED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} erlangte seine wahre Kraft durch Ultra-Burst!"),
	[STRINGID_TEAMGAINEDEXP]                        = COMPOUND_STRING("Der Rest deines Teams erhielt Erfahrungspunkte dank dem EP-Teiler!\p"),
	...
	[STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Scharfkantige Stahlstücke begannen um {B_DEF_TEAM2} Pokémon zu schweben!"),
	...
	[STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("Die Stahlstücke um {B_ATK_TEAM2} Pokémon verschwanden!"),
	[STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon wurden von Ranken gefangen!"),
	[STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde von Giga-Ranken verletzt!"),
	[STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon wurden in einem Wasserstrudel gefangen!"),
	[STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde vom Strudel von G-Max Kanonade verletzt!"),
	[STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon wurden von Feuer umgeben!"),
	[STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} brennt in den Flammen von G-Max Wildfire!"),
	[STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon wurden von Felsen umgeben!"),
	[STRINGID_PKMNHURTBYROCKSTHROWN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde von Felsen verletzt, die von G-Max Volcalith geschleudert wurden!"),
	...
	[STRINGID_THETWOMOVESBECOMEONE]                 = COMPOUND_STRING("Die beiden Attacken wurden zu einer! Es ist eine kombinierte Attacke!{PAUSE 16}"),
	[STRINGID_ARAINBOWAPPEAREDONSIDE]               = COMPOUND_STRING("Ein Regenbogen erschien auf der Seite von {B_ATK_TEAM2}!"),
	[STRINGID_THERAINBOWDISAPPEARED]                = COMPOUND_STRING("Der Regenbogen auf der Seite von {B_ATK_TEAM2} verschwand!"),
	[STRINGID_WAITINGFORPARTNERSMOVE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wartet auf {B_ATK_PARTNER_NAME}s Attacke…{PAUSE 16}"),
	[STRINGID_SEAOFFIREENVELOPEDSIDE]               = COMPOUND_STRING("Ein Meer aus Feuer umhüllte {B_DEF_TEAM2} Team!"),
	[STRINGID_HURTBYTHESEAOFFIRE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wurde vom Meer aus Feuer verletzt!"),
	[STRINGID_THESEAOFFIREDISAPPEARED]              = COMPOUND_STRING("Das Meer aus Feuer um {B_ATK_TEAM2} Team verschwand!"),
	[STRINGID_SWAMPENVELOPEDSIDE]                   = COMPOUND_STRING("Ein Sumpf umhüllte {B_DEF_TEAM2} Team!"),
	[STRINGID_THESWAMPDISAPPEARED]                  = COMPOUND_STRING("Der Sumpf um {B_ATK_TEAM2} Team verschwand!"),
	[STRINGID_PKMNTELLCHILLINGRECEPTIONJOKE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bereitet einen eiskalten Witz vor!"),
	...
	[STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("Ein bizarrer Bereich wurde geschaffen, in dem die Effekte von Items der Pokémon verloren gehen!"),
	[STRINGID_BIZARREAREACREATED]                   = COMPOUND_STRING("Ein bizarrer Bereich wurde geschaffen, in dem Verteidigung und Spezialverteidigung getauscht werden!"),
	...
	[STRINGID_BOOSTERENERGYACTIVATES]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} nutzte sein {B_LAST_ITEM}, um {B_SCR_ABILITY} zu aktivieren!"),
	[STRINGID_FOGCREPTUP]                           = COMPOUND_STRING("Der Nebel kroch so dick wie Suppe auf!"),
	[STRINGID_FOGISDEEP]                            = COMPOUND_STRING("Der Nebel ist dicht…"),
	[STRINGID_FOGLIFTED]                            = COMPOUND_STRING("Der Nebel verzog sich."),
	...
	[STRINGID_SUNLIGHTISHARSH]                      = COMPOUND_STRING("Das Sonnenlicht ist grell!"),
	...
	[STRINGID_MISTSWIRLSAROUND]                     = COMPOUND_STRING("Nebel wirbelt über das Schlachtfeld!"),
	...
	[STRINGID_WAGGLINGAFINGER]                      = COMPOUND_STRING("Ein wackelnder Finger ließ es {B_CURRENT_MOVE} einsetzen!"),
	...
	[STRINGID_SENDCAUGHTMONPARTYORBOX]              = COMPOUND_STRING("Willst du {B_DEF_NAME} in deine Party aufnehmen?"),
	...
	[STRINGID_QUESTIONFORFEITBATTLE]                = COMPOUND_STRING("Willst du diese Schlacht aufgeben und jetzt abbrechen? Das Aufgeben ist gleichbedeutend mit einer Niederlage."),
	[STRINGID_POWERCONSTRUCTPRESENCEOFMANY]         = COMPOUND_STRING("Du spürst die Präsenz vieler!"),
	[STRINGID_POWERCONSTRUCTTRANSFORM]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} verwandelte sich in seine Vollform!"),
	[STRINGID_ABILITYSHIELDPROTECTS]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}s Fähigkeit wird durch die Effekte von {B_LAST_ITEM} geschützt!"),
    ...
    [STRINGID_PKMNDISGUISEWASBUSTED]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Tarnung ist enthüllt!"),
    ...
    [STRINGID_WILDPKMNDROPPEDITEM]                  = COMPOUND_STRING("Das wilde Pokémon verlor\nsein {B_LAST_ITEM}!\p"),
...
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{BACKGROUND DYNAMIC_COLOR5}{TEXT_COLORS DYNAMIC_COLOR4 DYNAMIC_COLOR6 DYNAMIC_COLOR5}Hebel\nwohin?");
...
const u8 gText_WillChampionshipDreamComeTrue[] = _("Wird der Traum des Championship war?!\p");
...
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} wird von\n{B_OPPONENT_MON1_NAME} {B_TRAINER2_NAME_WITH_CLASS} in den\lKampf geschickt!\p{B_OPPONENT_MON2_NAME} wird von\n  in den\lKampf geschickt!");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_NAME_WITH_CLASS} wird von\n{B_BUFF1}  in den\lKampf geschickt!");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS} {B_TRAINER2_NAME_WITH_CLASS}\nund  \lmöchten kämpfen!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_NAME_WITH_CLASS} wird von\n{B_PLAYER_MON2_NAME} {B_PLAYER_MON1_NAME} in den\lKampf geschickt! Los! !");
...
static const u8 sText_PlayerLostAgainstTrainer1[] = _("Du hast gegen {B_TRAINER1_NAME_WITH_CLASS}\nverloren!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("Du hast unentschieden mit {B_TRAINER1_NAME_WITH_CLASS}!");
const u8 gText_RecordBattleToPass[] = _("Kampf auf dem Pass\ndokumentieren?");
const u8 gText_BattleRecordedOnPass[] = _("{B_PLAYER_NAME}'s ergebnis wurde auf dem Pass\ndokumentiert.");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("Du wirst von {B_LINK_OPPONENT1_NAME}\nherausgefordert!\p");
static const u8 sText_TwoLinkTrainersWantToBattlePause[] = _("Du wirst von {B_LINK_OPPONENT1_NAME} und {B_LINK_OPPONENT2_NAME}\nherausgefordert!\p");
