...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
	...
	[STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_LAST_ITEM} von {B_ATK_NAME_WITH_PREFIX}\nreagiert auf den Mega-Ring!"),
	...
	[STRINGID_ATTACKERCUREDTARGETSTATUS]            = COMPOUND_STRING("Status von {B_DEF_NAME_WITH_PREFIX}\nwird normal!"),
	...
	[STRINGID_CANACTFASTERTHANKSTO]                 = COMPOUND_STRING("Dank {B_LAST_ITEM} kann\n{B_ATK_NAME_WITH_PREFIX}\lschneller handeln als sonst!"),
	...
	[STRINGID_STUFFCHEEKSCANTSELECT]                = COMPOUND_STRING("Die Attacke geht nicht, weil das\nPokémon keine Beere gegessen hat!\p"),
	...
	[STRINGID_MISTSWIRLSAROUND]                     = COMPOUND_STRING("Am Boden breitet sich dichter Nebel\naus!"),
	[STRINGID_ELECTRICCURRENTISRUNNING]             = COMPOUND_STRING("Elektrische Energie fließt durch den\nBoden!"),
	[STRINGID_SEEMSWEIRD]                           = COMPOUND_STRING("Der Boden fühlt sich seltsam an!"),
