...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_GLASS_WORKSHOP_VENDOR] =
    {
        ...
        COMPOUND_STRING("Schwrz. Flöte"),
        COMPOUND_STRING("Edler Stuhl"),
        COMPOUND_STRING("Edler Tisch"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("Kuss-Poster{CLEAR_TO 0x5E}16GP"),
        COMPOUND_STRING("Kuss-Kissen{CLEAR_TO 0x5E}32GP"),
        COMPOUND_STRING("Kussilla-Puppe{CLEAR_TO 0x5E}32GP"),
        COMPOUND_STRING("Togepi-Puppe{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Mauzi-Puppe{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Piepi-Puppe{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Ditto-Puppe{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Feurigel-Puppe{CLEAR_TO 0x5E}80GP"),
        COMPOUND_STRING("Endivie-Puppe{CLEAR_TO 0x5E}80GP"),
        COMPOUND_STRING("Karnimanipuppe{CLEAR_TO 0x5E}80GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("Lapras-Puppe{CLEAR_TO 0x60}128GP"),
        COMPOUND_STRING("Relaxo-Puppe{CLEAR_TO 0x60}128GP"),
        COMPOUND_STRING("Bisaflor-Puppe{CLEAR_TO 0x60}256GP"),
        COMPOUND_STRING("Glurak-Puppe{CLEAR_TO 0x60}256GP"),
        COMPOUND_STRING("Turtok-Puppe{CLEAR_TO 0x60}256GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("Protein{CLEAR_TO 0x64}1GP"),
        COMPOUND_STRING("Kalzium{CLEAR_TO 0x64}1GP"),
        COMPOUND_STRING("Eisen{CLEAR_TO 0x64}1GP"),
        COMPOUND_STRING("Zink{CLEAR_TO 0x64}1GP"),
        COMPOUND_STRING("Carbon{CLEAR_TO 0x64}1GP"),
        COMPOUND_STRING("KP-Plus{CLEAR_TO 0x64}1GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        COMPOUND_STRING("Überreste{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Schlohkraut{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Flinkklaue{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Mentalkraut{CLEAR_TO 0x5E}48GP"),
        COMPOUND_STRING("Blendpuder{CLEAR_TO 0x5E}64GP"),
        COMPOUND_STRING("Wahlband{CLEAR_TO 0x5E}64GP"),
        COMPOUND_STRING("King-Stein{CLEAR_TO 0x5E}64GP"),
        COMPOUND_STRING("Fokus-Band{CLEAR_TO 0x5E}64GP"),
        COMPOUND_STRING("Scope-Linse{CLEAR_TO 0x5E}64GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BERRY_POWDER_VENDOR] =
    {
        COMPOUND_STRING("Energiestaub{CLEAR_TO 114}{FONT_SMALL}50"),
        COMPOUND_STRING("Kraftwurzel{CLEAR_TO 114}{FONT_SMALL}80"),
        COMPOUND_STRING("Heilpuder{CLEAR_TO 114}{FONT_SMALL}50"),
        COMPOUND_STRING("Vitalkraut{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("Protein{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("Eisen{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("Carbon{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("Kalzium{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("Zink{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("KP-Plus{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("AP-Plus{CLEAR_TO 99}{FONT_SMALL}3.000"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("Weichei{CLEAR_TO 0x4E}16GP"),
        COMPOUND_STRING("Geowurf{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Traumfresser{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Megahieb{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Megakick{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Bodyslam{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Steinhagel{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Konter{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Donnerwelle{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Schwerttanz{CLEAR_TO 0x4E}48GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("Einigler{CLEAR_TO 0x4E}16GP"),
        COMPOUND_STRING("Schnarcher{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Lehmschelle{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Sternschauer{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Eissturm{CLEAR_TO 0x4E}24GP"),
        COMPOUND_STRING("Ausdauer{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Psycho-Plus{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Eisschlag{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Donnerschlag{CLEAR_TO 0x4E}48GP"),
        COMPOUND_STRING("Feuerschlag{CLEAR_TO 0x4E}48GP"),
        gText_Exit
    },
#if IS_HNS
        [SCROLL_MULTI_BF_MOVE_TUTOR_3] =
    {
        COMPOUND_STRING("Fauna-Statue{CLEAR_TO 0x4E}64GP"),
        COMPOUND_STRING("Lohekanonade{CLEAR_TO 0x4E}64GP"),
        COMPOUND_STRING("Aquahaubitze{CLEAR_TO 0x4E}64GP"),
        gText_Exit
    },
#endif
