...
{
    COMPOUND_STRING("Der Anwärter auf den Titel des Champs!"), // Highest potential
    COMPOUND_STRING("Der sichere Finalist."),
    COMPOUND_STRING("Ein Kandidat für die ersten Drei."),
    COMPOUND_STRING("Ein Kandidat, der Erster werden könnte."),
    COMPOUND_STRING("Ein Team mit riesigem Potenzial."),
    COMPOUND_STRING("Die unbekannte Größe dieses Turniers."),
    COMPOUND_STRING("Ein Team, besser als der Durchschnitt."),
    COMPOUND_STRING("Das durchschnittliche Team."),
    COMPOUND_STRING("Team mit durchschnittlichem Potenzial."),
    COMPOUND_STRING("Schwächer als der Durchschnitt."),
    COMPOUND_STRING("Team, das nach dem ersten Sieg strebt."),
    COMPOUND_STRING("Ein Sieg und dieses Team wäre stolz."),
    COMPOUND_STRING("Alles in allem ein schwaches Team."),
    COMPOUND_STRING("Team mit schwachem Potenzial."),
    COMPOUND_STRING("Ein Team, das wohl nicht gewinnen wird."),
    COMPOUND_STRING("Dieses Team wird nicht gewinnen."), // Lowest potential
    COMPOUND_STRING("Die perfekten, unschlagbaren Stars."), // Dome Ace Tucker
};
...
{
    [DOME_BATTLE_STYLE_RISKY]           = COMPOUND_STRING("Hat einen Hang zur Katastrophe."),
    [DOME_BATTLE_STYLE_STALL]           = COMPOUND_STRING("Hält lange Kämpfe spielend durch."),
    [DOME_BATTLE_STYLE_VARIED]          = COMPOUND_STRING("Passt Taktik an den Gegner an."),
    [DOME_BATTLE_STYLE_COMBO_HIGH]      = COMPOUND_STRING("Starke Form eines Gewinners erkennbar."),
    [DOME_BATTLE_STYLE_RARE_MOVES]      = COMPOUND_STRING("Setzt manchmal seltene Attacken ein."),  // Seems like the text for these two was swapped
    [DOME_BATTLE_STYLE_RARE_MOVE]       = COMPOUND_STRING("Setzt verwirrende Attacken ein."), //
    [DOME_BATTLE_STYLE_HP]              = COMPOUND_STRING("Behält im Kampf ständig KP im Auge."),
    [DOME_BATTLE_STYLE_STORE_POWER]     = COMPOUND_STRING("Gut im Bewahren von Kraft."),
    [DOME_BATTLE_STYLE_ENFEEBLE_LOW]    = COMPOUND_STRING("Gut im Schwächen von Gegnern."),
    [DOME_BATTLE_STYLE_LUCK]            = COMPOUND_STRING("Verlässt sich auf das Glück."),
    [DOME_BATTLE_STYLE_REGAL]           = COMPOUND_STRING("Greift hoheitsvoll an."),
    [DOME_BATTLE_STYLE_LOW_PP]          = COMPOUND_STRING("Liebt starke, AP-schwache Attacken."),
    [DOME_BATTLE_STYLE_STATUS_ATK]      = COMPOUND_STRING("Schwächt und greift dann an."),
    [DOME_BATTLE_STYLE_ENDURE]          = COMPOUND_STRING("Erträgt kämpfend alle Angriffe."),
    [DOME_BATTLE_STYLE_STATUS]          = COMPOUND_STRING("Verwirrt den Gegner emotional."),
    [DOME_BATTLE_STYLE_STRAIGHTFORWARD] = COMPOUND_STRING("Setzt starke, forsche Attacken ein."),
    [DOME_BATTLE_STYLE_AGGRESSIVE]      = COMPOUND_STRING("Setzt aggressive, starke Attacken ein."),
    [DOME_BATTLE_STYLE_DEF]             = COMPOUND_STRING("Kämpft und duckt sich dabei clever."),
    [DOME_BATTLE_STYLE_ENFEEBLE_HIGH]   = COMPOUND_STRING("Seine Attacken verärgern den Gegner."),
    [DOME_BATTLE_STYLE_POPULAR_POWER]   = COMPOUND_STRING("Setzt viele gängige Attacken ein."),
    [DOME_BATTLE_STYLE_COMBO_LOW]       = COMPOUND_STRING("Setzt starke Attacken-Combos ein."),
    [DOME_BATTLE_STYLE_ACCURATE]        = COMPOUND_STRING("Attacken mit hoher Trefferquote."),
    [DOME_BATTLE_STYLE_POWERFUL]        = COMPOUND_STRING("Setzt kühn spektakuläre Attacken ein."),
    [DOME_BATTLE_STYLE_ATK_OVER_DEF]    = COMPOUND_STRING("Setzt auf Offensive statt Defensive."),
    [DOME_BATTLE_STYLE_DEF_OVER_ATK]    = COMPOUND_STRING("Setzt auf Defensive statt Offensive."),
    [DOME_BATTLE_STYLE_POPULAR_STRONG]  = COMPOUND_STRING("Schneller Angriff mit starken Attacken."),
    [DOME_BATTLE_STYLE_EFFECTS]         = COMPOUND_STRING("Attacken mit zusätzlicher Wirkung."),
    [DOME_BATTLE_STYLE_BALANCED]        = COMPOUND_STRING("Gut ausbalancierter Mix von Attacken."),
    [DOME_BATTLE_STYLE_UNUSED1]         = COMPOUND_STRING("Dies ist Beispiel 1."),
    [DOME_BATTLE_STYLE_UNUSED2]         = COMPOUND_STRING("Dies ist Beispiel 2."),
    [DOME_BATTLE_STYLE_UNUSED3]         = COMPOUND_STRING("Dies ist Beispiel 3."),
    [DOME_BATTLE_STYLE_UNUSED4]         = COMPOUND_STRING("Dies ist Beispiel 4."),
};
...
{
    COMPOUND_STRING("Legt Wert auf KP und Angriff."),              // DOME_TEXT_TWO_GOOD_STATS and DOME_TEXT_HP start here
    COMPOUND_STRING("Legt Wert auf KP und Verteidigung."),
    COMPOUND_STRING("Legt Wert auf KP und Initiative."),
    COMPOUND_STRING("Legt Wert auf KP und SP. Angr."),
    COMPOUND_STRING("Legt Wert auf KP und SP. Vert."),
    COMPOUND_STRING("Legt Wert auf Angriff und Vert."),         // DOME_TEXT_ATK starts here
    COMPOUND_STRING("Legt Wert auf Angriff und Initiative."),
    COMPOUND_STRING("Legt Wert auf Angriff und SP. Angr."),
    COMPOUND_STRING("Legt Wert auf Angriff und SP. Vert."),
    COMPOUND_STRING("Legt Wert auf Vert. und INIT."),          // DOME_TEXT_DEF starts here
    COMPOUND_STRING("Legt Wert auf Vert. und SP. Angr."),
    COMPOUND_STRING("Legt Wert auf Vert. und SP. Vert."),
    COMPOUND_STRING("Legt Wert auf INIT. und SP. Angr."),       // DOME_TEXT_SPEED starts here
    COMPOUND_STRING("Legt Wert auf INIT. und SP. Vert."),
    COMPOUND_STRING("Legt Wert auf SP. Angr. u. SP. Vert."), // DOME_TEXT_SPATK starts here
    COMPOUND_STRING("Legt Wert auf KP."),                         // DOME_TEXT_ONE_GOOD_STAT starts here
    COMPOUND_STRING("Legt Wert auf Angriff."),
    COMPOUND_STRING("Legt Wert auf Verteidigung."),
    COMPOUND_STRING("Legt Wert auf Initiative."),
    COMPOUND_STRING("Legt Wert auf SP. Angriff."),
    COMPOUND_STRING("Legt Wert auf SP. Verteidigung."),
    COMPOUND_STRING("Vernachlässigt KP und Angriff."),                // DOME_TEXT_TWO_BAD_STATS starts here
    COMPOUND_STRING("Vernachlässigt KP und Verteidigung."),
    COMPOUND_STRING("Vernachlässigt KP und Initiative."),
    COMPOUND_STRING("Vernachlässigt KP und SP. Angriff."),
    COMPOUND_STRING("Vernachlässigt KP und SP. Vert."),
    COMPOUND_STRING("Vernachlässigt Angr. und Vert."),
    COMPOUND_STRING("Vernachlässigt Angr. und INIT."),
    COMPOUND_STRING("Vernachlässigt Angr. und SP. Angr."),
    COMPOUND_STRING("Vernachlässigt Angr. und SP. Vert."),
    COMPOUND_STRING("Vernachlässigt Vert. und INIT."),
    COMPOUND_STRING("Vernachlässigt Vert. und SP. Angr."),
    COMPOUND_STRING("Vernachlässigt Vert. und SP. Vert."),
    COMPOUND_STRING("Vernachlässigt INIT. und SP. Angr."),
    COMPOUND_STRING("Vernachlässigt INIT. und SP. Vert."),
    COMPOUND_STRING("Vernachlässigt SP. Angr. und SP. Vert."),
    COMPOUND_STRING("Vernachlässigt KP."),                           // DOME_TEXT_ONE_BAD_STAT starts here
    COMPOUND_STRING("Vernachlässigt Angriff."),
    COMPOUND_STRING("Vernachlässigt Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Initiative."),
    COMPOUND_STRING("Vernachlässigt SPEZ. Angriff."),
    COMPOUND_STRING("Vernachlässigt SPEZ. Verteidigung."),
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("Zieht Pokémon ausgewogen auf."),
};
...
{
    COMPOUND_STRING("Runde 1, Kampf 1"),
    COMPOUND_STRING("Runde 1, Kampf 2"),
    COMPOUND_STRING("Runde 1, Kampf 3"),
    COMPOUND_STRING("Runde 1, Kampf 4"),
    COMPOUND_STRING("Runde 1, Kampf 5"),
    COMPOUND_STRING("Runde 1, Kampf 6"),
    COMPOUND_STRING("Runde 1, Kampf 7"),
    COMPOUND_STRING("Runde 1, Kampf 8"),
    COMPOUND_STRING("Runde 2, Kampf 1"),
    COMPOUND_STRING("Runde 2, Kampf 2"),
    COMPOUND_STRING("Runde 2, Kampf 3"),
    COMPOUND_STRING("Runde 2, Kampf 4"),
    COMPOUND_STRING("Halbfinale Kampf 1"),
    COMPOUND_STRING("Halbfinale Kampf 2"),
    COMPOUND_STRING("Finale"),
};

static const u8 *const sBattleDomeWinTexts[] =
{
    [DOME_TEXT_NO_WINNER_YET]    = COMPOUND_STRING("Lasst den Kampf beginnen!"),
    [DOME_TEXT_WON_USING_MOVE]   = COMPOUND_STRING("{STR_VAR_1} gewinnt mit {STR_VAR_2}!"),
    [DOME_TEXT_CHAMP_USING_MOVE] = COMPOUND_STRING("{STR_VAR_1} wird der Champ!"),
    [DOME_TEXT_WON_ON_FORFEIT]   = COMPOUND_STRING("{STR_VAR_1} gewinnt durch Aufgabe!"),
    [DOME_TEXT_CHAMP_ON_FORFEIT] = COMPOUND_STRING("{STR_VAR_1} gewinnt durch Aufgabe!"),
    [DOME_TEXT_WON_NO_MOVES]     = COMPOUND_STRING("{STR_VAR_1} gewinnt ohne anzugreifen!"),
    [DOME_TEXT_CHAMP_NO_MOVES]   = COMPOUND_STRING("{STR_VAR_1} gewinnt ohne anzugreifen!"),
};
