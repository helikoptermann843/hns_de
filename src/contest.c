...
//Text
const u8 gText_LinkStandby4[] = COMPOUND_STRING("Verbindung…");

const u8 gText_AppealNumWhichMoveWillBePlayed[] = COMPOUND_STRING("Ausdruck {STR_VAR_1}! Welche\nAttacke wird gezeigt?");
const u8 gText_AppealNumButItCantParticipate[] = COMPOUND_STRING("Ausdruck {STR_VAR_1}! Aber es\nkann nicht teilnehmen!");
const u8 gText_MonAppealedWithMove[] = COMPOUND_STRING("{STR_VAR_1} führt\n{STR_VAR_2} vor!");
const u8 gText_MonWasWatchingOthers[] = COMPOUND_STRING("{STR_VAR_1} beobachtet\ndie anderen.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_AllOutOfAppealTime[] = COMPOUND_STRING("Soweit zur\nAusdruckskraft!{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_JudgeLookedAtMonExpectantly[] = COMPOUND_STRING("Der Juror betrachtet\n{STR_VAR_1} interessiert.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_AppealComboWentOverWell[] = COMPOUND_STRING("Die Combo der Ausdrücke\nkam gut an.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_AppealComboWentOverVeryWell[] = COMPOUND_STRING("Die Combo der Ausdrücke\nkam sehr gut an.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_AppealComboWentOverExcellently[] = COMPOUND_STRING("Die Combo der Ausdrücke\nkam exzellent an.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonWasTooNervousToMove[] = COMPOUND_STRING("{STR_VAR_1} ist zu nervös,\num etwas vorzuführen.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_CouldntImproveItsCondition[] = COMPOUND_STRING("Es konnte seinen Aus-\ndruck nicht verstärken…{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_BadConditionResultedInWeakAppeal[] = COMPOUND_STRING("Schwacher Ausdruck we-\ngen schlechter Kondition.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonWasUnaffected[] = COMPOUND_STRING("{STR_VAR_1} blieb\nunbeeindruckt.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_RepeatedAppeal[] = COMPOUND_STRING("{STR_VAR_1} enttäuscht\ndurch Wiederholung.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonsXWentOverGreat[] = COMPOUND_STRING("Die {STR_VAR_3} von\n{STR_VAR_1} war sehr gut.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonsXDidntGoOverWell[] = COMPOUND_STRING("Die {STR_VAR_3} von\n{STR_VAR_1} war nicht gut.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonsXGotTheCrowdGoing[] = COMPOUND_STRING("{STR_VAR_1} begeistert\nPublikum mit {STR_VAR_3}.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonCantAppealNextTurn[] = COMPOUND_STRING("{STR_VAR_1} setzt in der \nfolgenden Runde aus.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_AttractedCrowdsAttention[] = COMPOUND_STRING("Die Aufmerksamkeit des\nPublikums liegt auf ihm.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_CrowdContinuesToWatchMon[] = COMPOUND_STRING("Das Publikum beobachtet\nweiterhin {STR_VAR_3}.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
const u8 gText_MonsMoveIsIgnored[] = COMPOUND_STRING("{STR_VAR_2} von\n{STR_VAR_1} sah keiner.{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}{PAUSE 0x0F}");
...
const struct ContestCategory gContestCategoryInfo[CONTEST_CATEGORIES_COUNT + 1] =
{
    [CONTEST_CATEGORY_COOL] =
    {
        ...
        .generic = COMPOUND_STRING("Coole Att."),
        .negativeTrait = COMPOUND_STRING("Scheu"),
        .palette = 13,
        .tile = 0x4040,
    },
    ...
    {
        .name = COMPOUND_STRING("Schön."),
        .condition = COMPOUND_STRING("Schönheit"),
        .generic = COMPOUND_STRING("Schöne Att."),
        .negativeTrait = COMPOUND_STRING("Besorgnis"),
        .palette = 14,
        .tile = 0x4045,
    },
    ...
    {
        .name = COMPOUND_STRING("Anmut"),
        .condition = COMPOUND_STRING("Anmut"),
        .generic = COMPOUND_STRING("Anmut-Att."),
        .negativeTrait = COMPOUND_STRING("Faulheit"),
        .palette = 14,
        .tile = 0x404A,
    },
    ...
    {
        .name = COMPOUND_STRING("Klug."),
        .condition = COMPOUND_STRING("Klugheit"),
        .generic = COMPOUND_STRING("Kluge Att."),
        .negativeTrait = COMPOUND_STRING("Zögern"),
        .palette = 15,
        .tile = 0x406A,
    },
    ...
    [CONTEST_CATEGORY_TOUGH] =
    {
        ...
        .generic = COMPOUND_STRING("Starke Att."),
        .negativeTrait = COMPOUND_STRING("Furcht"),
        .palette = 13,
        .tile = 0x408A,
    },
