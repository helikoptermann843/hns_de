...
const u8 gText_Munchlax[] = _("Mampfaxo{CLEAR_TO 0x58}2.800");
const u8 gText_Dratini[] = _("Dratini{CLEAR_TO 0x58}5.500");
const u8 gText_Porygon[] = _("Porygon{CLEAR_TO 0x58}6.500");
