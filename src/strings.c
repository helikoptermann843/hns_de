...
const u8 gText_AButton[] = _("A-Taste"); // Unused
const u8 gText_BButton[] = _("B-Taste"); // Unused
const u8 gText_RButton[] = _("R-Taste"); // Unused
const u8 gText_LButton[] = _("L-Taste"); // Unused
const u8 gText_Start[] = _("Start"); // Unused
const u8 gText_Select[] = _("SELECT"); // Unused
const u8 gText_ControlPad[] = _("+ Steuerkreuz"); // Unused
const u8 gText_LButtonRButton[] = _("L-Taste  R-Taste"); // Unused
...
const u8 gText_PkmnRegainhedHealth[] = _("{STR_VAR_1} erholte sich.{PAUSE_UNTIL_PRESS}"); // Unused
...
const u8 gText_PkmnGainedExp[] = _("{STR_VAR_1} erhielt {STR_VAR_2} E-Punkte!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnTransformed[] = _("{STR_VAR_1} verwandelte sich!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WithFourPhrases[] = _("Mit vier Ausdrücken,"); // Unused
...
const u8 gText_QuitEditing2[] = _("Das Textverfassen beenden?"); // Unused
...
const u8 gText_ThatsTrendyAlready[] = _("Das ist schon Trend!"); // Unused
const u8 gText_CombineTwoWordsOrPhrases3[] = _("Kombiniere 2 Wörter/Ausdrücke.");
const u8 gText_QuitGivingInfo[] = _("Keine Auskunft mehr geben?"); // Unused
