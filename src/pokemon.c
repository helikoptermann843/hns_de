...
static const enum NationalDexOrder sJohtoToNationalOrder[JOHTO_DEX_COUNT] =
{
    ...
    JOHTO_TO_NATIONAL(BIDOOF),
    JOHTO_TO_NATIONAL(BIBAREL),
    JOHTO_TO_NATIONAL(KRICKETOT),
    JOHTO_TO_NATIONAL(KRICKETUNE),
    ...
    JOHTO_TO_NATIONAL(PACHIRISU),
    JOHTO_TO_NATIONAL(BUIZEL),
    JOHTO_TO_NATIONAL(FLOATZEL),
    JOHTO_TO_NATIONAL(CHERUBI),
    JOHTO_TO_NATIONAL(CHERRIM),
    JOHTO_TO_NATIONAL(SHELLOS),
    JOHTO_TO_NATIONAL(GASTRODON),
    ...
    JOHTO_TO_NATIONAL(STUNKY),
    JOHTO_TO_NATIONAL(SKUNTANK),
    ...
    JOHTO_TO_NATIONAL(LITLEO),
    JOHTO_TO_NATIONAL(PYROAR),
    JOHTO_TO_NATIONAL(SKIDDO),
    JOHTO_TO_NATIONAL(GOGOAT),
    JOHTO_TO_NATIONAL(PANCHAM),
    JOHTO_TO_NATIONAL(PANGORO),
    JOHTO_TO_NATIONAL(FURFROU),
    JOHTO_TO_NATIONAL(ESPURR),
    JOHTO_TO_NATIONAL(MEOWSTIC),
    JOHTO_TO_NATIONAL(SPRITZEE),
    JOHTO_TO_NATIONAL(AROMATISSE),
    JOHTO_TO_NATIONAL(SWIRLIX),
    JOHTO_TO_NATIONAL(SLURPUFF),
    JOHTO_TO_NATIONAL(INKAY),
    JOHTO_TO_NATIONAL(MALAMAR),
    JOHTO_TO_NATIONAL(SKRELP),
    JOHTO_TO_NATIONAL(DRAGALGE),
    JOHTO_TO_NATIONAL(CLAUNCHER),
    JOHTO_TO_NATIONAL(CLAWITZER),
    JOHTO_TO_NATIONAL(HELIOPTILE),
    JOHTO_TO_NATIONAL(HELIOLISK),
    JOHTO_TO_NATIONAL(TYRUNT),
    JOHTO_TO_NATIONAL(TYRANTRUM),
    JOHTO_TO_NATIONAL(AMAURA),
    JOHTO_TO_NATIONAL(AURORUS),
    JOHTO_TO_NATIONAL(HAWLUCHA),
    JOHTO_TO_NATIONAL(GOOMY),
    JOHTO_TO_NATIONAL(SLIGGOO),
    JOHTO_TO_NATIONAL(GOODRA),
    JOHTO_TO_NATIONAL(PHANTUMP),
    JOHTO_TO_NATIONAL(TREVENANT),
    JOHTO_TO_NATIONAL(BERGMITE),
    JOHTO_TO_NATIONAL(AVALUGG),
...
static const enum NationalDexOrder sObtainableToNationalOrder[OBTAINABLE_DEX_COUNT] =
{
    ...
    // Sinnoh
    OBTAINABLE_TO_NATIONAL(TURTWIG),
    OBTAINABLE_TO_NATIONAL(GROTLE),
    OBTAINABLE_TO_NATIONAL(TORTERRA),
    OBTAINABLE_TO_NATIONAL(CHIMCHAR),
    OBTAINABLE_TO_NATIONAL(MONFERNO),
    OBTAINABLE_TO_NATIONAL(INFERNAPE),
    OBTAINABLE_TO_NATIONAL(PIPLUP),
    OBTAINABLE_TO_NATIONAL(PRINPLUP),
    OBTAINABLE_TO_NATIONAL(EMPOLEON),
    OBTAINABLE_TO_NATIONAL(STARLY),
    OBTAINABLE_TO_NATIONAL(STARAVIA),
    OBTAINABLE_TO_NATIONAL(STARAPTOR),
    OBTAINABLE_TO_NATIONAL(BIDOOF),
    OBTAINABLE_TO_NATIONAL(BIBAREL),
    OBTAINABLE_TO_NATIONAL(KRICKETOT),
    OBTAINABLE_TO_NATIONAL(KRICKETUNE),
    OBTAINABLE_TO_NATIONAL(SHINX),
    OBTAINABLE_TO_NATIONAL(LUXIO),
    OBTAINABLE_TO_NATIONAL(LUXRAY),
    OBTAINABLE_TO_NATIONAL(CRANIDOS),
    OBTAINABLE_TO_NATIONAL(RAMPARDOS),
    OBTAINABLE_TO_NATIONAL(SHIELDON),
    OBTAINABLE_TO_NATIONAL(BASTIODON),
    OBTAINABLE_TO_NATIONAL(BURMY),
    OBTAINABLE_TO_NATIONAL(WORMADAM),
    OBTAINABLE_TO_NATIONAL(MOTHIM),
    OBTAINABLE_TO_NATIONAL(COMBEE),
    OBTAINABLE_TO_NATIONAL(VESPIQUEN),
    OBTAINABLE_TO_NATIONAL(PACHIRISU),
    OBTAINABLE_TO_NATIONAL(BUIZEL),
    OBTAINABLE_TO_NATIONAL(FLOATZEL),
    OBTAINABLE_TO_NATIONAL(CHERUBI),
    OBTAINABLE_TO_NATIONAL(CHERRIM),
    OBTAINABLE_TO_NATIONAL(SHELLOS),
    OBTAINABLE_TO_NATIONAL(GASTRODON),
    OBTAINABLE_TO_NATIONAL(DRIFLOON),
    OBTAINABLE_TO_NATIONAL(DRIFBLIM),
    OBTAINABLE_TO_NATIONAL(BUNEARY),
    OBTAINABLE_TO_NATIONAL(LOPUNNY),
    OBTAINABLE_TO_NATIONAL(GLAMEOW),
    OBTAINABLE_TO_NATIONAL(PURUGLY),
    OBTAINABLE_TO_NATIONAL(STUNKY),
    OBTAINABLE_TO_NATIONAL(SKUNTANK),
    OBTAINABLE_TO_NATIONAL(BRONZOR),
    OBTAINABLE_TO_NATIONAL(BRONZONG),
    OBTAINABLE_TO_NATIONAL(SPIRITOMB),
    OBTAINABLE_TO_NATIONAL(GIBLE),
    OBTAINABLE_TO_NATIONAL(GABITE),
    OBTAINABLE_TO_NATIONAL(GARCHOMP),
    OBTAINABLE_TO_NATIONAL(RIOLU),
    OBTAINABLE_TO_NATIONAL(LUCARIO),
    OBTAINABLE_TO_NATIONAL(HIPPOPOTAS),
    OBTAINABLE_TO_NATIONAL(HIPPOWDON),
    OBTAINABLE_TO_NATIONAL(SKORUPI),
    OBTAINABLE_TO_NATIONAL(DRAPION),
    OBTAINABLE_TO_NATIONAL(CROAGUNK),
    OBTAINABLE_TO_NATIONAL(TOXICROAK),
    OBTAINABLE_TO_NATIONAL(CARNIVINE),
    OBTAINABLE_TO_NATIONAL(FINNEON),
    OBTAINABLE_TO_NATIONAL(LUMINEON),
    OBTAINABLE_TO_NATIONAL(SNOVER),
    OBTAINABLE_TO_NATIONAL(ABOMASNOW),
    OBTAINABLE_TO_NATIONAL(FLETCHLING),
    OBTAINABLE_TO_NATIONAL(FLETCHINDER),
    OBTAINABLE_TO_NATIONAL(TALONFLAME),
    OBTAINABLE_TO_NATIONAL(LITLEO),
    OBTAINABLE_TO_NATIONAL(PYROAR),
    OBTAINABLE_TO_NATIONAL(SKIDDO),
    OBTAINABLE_TO_NATIONAL(GOGOAT),
    OBTAINABLE_TO_NATIONAL(PANCHAM),
    OBTAINABLE_TO_NATIONAL(PANGORO),
    OBTAINABLE_TO_NATIONAL(FURFROU),
    OBTAINABLE_TO_NATIONAL(ESPURR),
    OBTAINABLE_TO_NATIONAL(MEOWSTIC),
    OBTAINABLE_TO_NATIONAL(SPRITZEE),
    OBTAINABLE_TO_NATIONAL(AROMATISSE),
    OBTAINABLE_TO_NATIONAL(SWIRLIX),
    OBTAINABLE_TO_NATIONAL(SLURPUFF),
    OBTAINABLE_TO_NATIONAL(INKAY),
    OBTAINABLE_TO_NATIONAL(MALAMAR),
    OBTAINABLE_TO_NATIONAL(SKRELP),
    OBTAINABLE_TO_NATIONAL(DRAGALGE),
    OBTAINABLE_TO_NATIONAL(CLAUNCHER),
    OBTAINABLE_TO_NATIONAL(CLAWITZER),
    OBTAINABLE_TO_NATIONAL(HELIOPTILE),
    OBTAINABLE_TO_NATIONAL(HELIOLISK),
    OBTAINABLE_TO_NATIONAL(TYRUNT),
    OBTAINABLE_TO_NATIONAL(TYRANTRUM),
    OBTAINABLE_TO_NATIONAL(AMAURA),
    OBTAINABLE_TO_NATIONAL(AURORUS),
    OBTAINABLE_TO_NATIONAL(HAWLUCHA),
    OBTAINABLE_TO_NATIONAL(GOOMY),
    OBTAINABLE_TO_NATIONAL(SLIGGOO),
    OBTAINABLE_TO_NATIONAL(GOODRA),
    OBTAINABLE_TO_NATIONAL(PHANTUMP),
    OBTAINABLE_TO_NATIONAL(TREVENANT),
    OBTAINABLE_TO_NATIONAL(BERGMITE),
    OBTAINABLE_TO_NATIONAL(AVALUGG),
    OBTAINABLE_TO_NATIONAL(NOIBAT),
    OBTAINABLE_TO_NATIONAL(NOIVERN),
    OBTAINABLE_TO_NATIONAL(LILLIPUP),
    OBTAINABLE_TO_NATIONAL(HERDIER),
    OBTAINABLE_TO_NATIONAL(STOUTLAND),
    OBTAINABLE_TO_NATIONAL(PURRLOIN),
    OBTAINABLE_TO_NATIONAL(LIEPARD),
    OBTAINABLE_TO_NATIONAL(PANSAGE),
    OBTAINABLE_TO_NATIONAL(SIMISAGE),
    OBTAINABLE_TO_NATIONAL(PANSEAR),
    OBTAINABLE_TO_NATIONAL(SIMISEAR),
    OBTAINABLE_TO_NATIONAL(PANPOUR),
    OBTAINABLE_TO_NATIONAL(SIMIPOUR),
    OBTAINABLE_TO_NATIONAL(ROGGENROLA),
    OBTAINABLE_TO_NATIONAL(BOLDORE),
    OBTAINABLE_TO_NATIONAL(GIGALITH),
    OBTAINABLE_TO_NATIONAL(WOOBAT),
    OBTAINABLE_TO_NATIONAL(SWOOBAT),
    OBTAINABLE_TO_NATIONAL(DRILBUR),
    OBTAINABLE_TO_NATIONAL(EXCADRILL),
    OBTAINABLE_TO_NATIONAL(AUDINO),
    OBTAINABLE_TO_NATIONAL(TIMBURR),
    OBTAINABLE_TO_NATIONAL(GURDURR),
    OBTAINABLE_TO_NATIONAL(CONKELDURR),
    OBTAINABLE_TO_NATIONAL(TYMPOLE),
    OBTAINABLE_TO_NATIONAL(PALPITOAD),
    OBTAINABLE_TO_NATIONAL(SEISMITOAD),
    OBTAINABLE_TO_NATIONAL(THROH),
    OBTAINABLE_TO_NATIONAL(SAWK),
    OBTAINABLE_TO_NATIONAL(VENIPEDE),
    OBTAINABLE_TO_NATIONAL(WHIRLIPEDE),
    OBTAINABLE_TO_NATIONAL(SCOLIPEDE),
    OBTAINABLE_TO_NATIONAL(COTTONEE),
    OBTAINABLE_TO_NATIONAL(WHIMSICOTT),
    OBTAINABLE_TO_NATIONAL(PETILIL),
    OBTAINABLE_TO_NATIONAL(LILLIGANT),
    OBTAINABLE_TO_NATIONAL(BASCULIN),
    OBTAINABLE_TO_NATIONAL(SANDILE),
    OBTAINABLE_TO_NATIONAL(KROKOROK),
    OBTAINABLE_TO_NATIONAL(KROOKODILE),
    OBTAINABLE_TO_NATIONAL(DARUMAKA),
    OBTAINABLE_TO_NATIONAL(DARMANITAN),
    OBTAINABLE_TO_NATIONAL(SCRAGGY),
    OBTAINABLE_TO_NATIONAL(SCRAFTY),
    OBTAINABLE_TO_NATIONAL(SIGILYPH),
    OBTAINABLE_TO_NATIONAL(YAMASK),
    OBTAINABLE_TO_NATIONAL(COFAGRIGUS),
    OBTAINABLE_TO_NATIONAL(TIRTOUGA),
    OBTAINABLE_TO_NATIONAL(CARRACOSTA),
    OBTAINABLE_TO_NATIONAL(ARCHEN),
    OBTAINABLE_TO_NATIONAL(ARCHEOPS),
    OBTAINABLE_TO_NATIONAL(TRUBBISH),
    OBTAINABLE_TO_NATIONAL(GARBODOR),
    OBTAINABLE_TO_NATIONAL(ZORUA),
    OBTAINABLE_TO_NATIONAL(ZOROARK),
    OBTAINABLE_TO_NATIONAL(GOTHITA),
    OBTAINABLE_TO_NATIONAL(GOTHORITA),
    OBTAINABLE_TO_NATIONAL(GOTHITELLE),
    OBTAINABLE_TO_NATIONAL(DUCKLETT),
    OBTAINABLE_TO_NATIONAL(SWANNA),
    OBTAINABLE_TO_NATIONAL(DEERLING),
    OBTAINABLE_TO_NATIONAL(SAWSBUCK),
    OBTAINABLE_TO_NATIONAL(EMOLGA),
    OBTAINABLE_TO_NATIONAL(FOONGUS),
    OBTAINABLE_TO_NATIONAL(AMOONGUSS),
    OBTAINABLE_TO_NATIONAL(FRILLISH),
    OBTAINABLE_TO_NATIONAL(JELLICENT),
    OBTAINABLE_TO_NATIONAL(JOLTIK),
    OBTAINABLE_TO_NATIONAL(GALVANTULA),
    OBTAINABLE_TO_NATIONAL(FERROSEED),
    OBTAINABLE_TO_NATIONAL(FERROTHORN),
    OBTAINABLE_TO_NATIONAL(TYNAMO),
    OBTAINABLE_TO_NATIONAL(EELEKTRIK),
    OBTAINABLE_TO_NATIONAL(EELEKTROSS),
    OBTAINABLE_TO_NATIONAL(ELGYEM),
    OBTAINABLE_TO_NATIONAL(BEHEEYEM),
    OBTAINABLE_TO_NATIONAL(LITWICK),
    OBTAINABLE_TO_NATIONAL(LAMPENT),
    OBTAINABLE_TO_NATIONAL(CHANDELURE),
    OBTAINABLE_TO_NATIONAL(AXEW),
    OBTAINABLE_TO_NATIONAL(FRAXURE),
    OBTAINABLE_TO_NATIONAL(HAXORUS),
    OBTAINABLE_TO_NATIONAL(CUBCHOO),
    OBTAINABLE_TO_NATIONAL(BEARTIC),
    OBTAINABLE_TO_NATIONAL(SHELMET),
    OBTAINABLE_TO_NATIONAL(ACCELGOR),
    OBTAINABLE_TO_NATIONAL(STUNFISK),
    OBTAINABLE_TO_NATIONAL(MIENFOO),
    OBTAINABLE_TO_NATIONAL(MIENSHAO),
    OBTAINABLE_TO_NATIONAL(DRUDDIGON),
    OBTAINABLE_TO_NATIONAL(GOLETT),
    OBTAINABLE_TO_NATIONAL(GOLURK),
    OBTAINABLE_TO_NATIONAL(PAWNIARD),
    OBTAINABLE_TO_NATIONAL(BISHARP),
    OBTAINABLE_TO_NATIONAL(BOUFFALANT),
    OBTAINABLE_TO_NATIONAL(RUFFLET),
    OBTAINABLE_TO_NATIONAL(BRAVIARY),
    OBTAINABLE_TO_NATIONAL(VULLABY),
    OBTAINABLE_TO_NATIONAL(MANDIBUZZ),
    OBTAINABLE_TO_NATIONAL(HEATMOR),
    OBTAINABLE_TO_NATIONAL(DEINO),
    OBTAINABLE_TO_NATIONAL(ZWEILOUS),
    OBTAINABLE_TO_NATIONAL(HYDREIGON),
    OBTAINABLE_TO_NATIONAL(PIKIPEK),
    OBTAINABLE_TO_NATIONAL(TRUMBEAK),
    OBTAINABLE_TO_NATIONAL(TOUCANNON),
    OBTAINABLE_TO_NATIONAL(ROCKRUFF),
    OBTAINABLE_TO_NATIONAL(LYCANROC),
    OBTAINABLE_TO_NATIONAL(MAREANIE),
    OBTAINABLE_TO_NATIONAL(TOXAPEX),
    OBTAINABLE_TO_NATIONAL(BUZZWOLE),
