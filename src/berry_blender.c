...
{
    [BLENDER_MISTER] = COMPOUND_STRING("Opi"),
    [BLENDER_LADDIE] = COMPOUND_STRING("Kumpel"),
    [BLENDER_LASSIE] = COMPOUND_STRING("Tussi"),
    [BLENDER_MASTER] = COMPOUND_STRING("Meister"),
    [BLENDER_DUDE]   = COMPOUND_STRING("Freund"),
