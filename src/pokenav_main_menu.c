...
#if IS_HNS
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{B_BUTTON}Zurück"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{B_BUTTON}Zurück"),
...
#else
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{A_BUTTON}Zoom {B_BUTTON}Zurück"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{A_BUTTON}Ganz {B_BUTTON}Zurück"),
...
#endif
    [HELPBAR_CONDITION_MON_LIST]    = COMPOUND_STRING("{A_BUTTON}Zustand {B_BUTTON}Zurück"),
    [HELPBAR_CONDITION_MON_STATUS]  = COMPOUND_STRING("{A_BUTTON}Markierung {B_BUTTON}Zurück"),
    [HELPBAR_CONDITION_MARKINGS]    = COMPOUND_STRING("{A_BUTTON}Wahl Mark. {B_BUTTON}Zurück"),
    [HELPBAR_MC_TRAINER_LIST]       = COMPOUND_STRING("{A_BUTTON}Menü {B_BUTTON}Zurück"),
    [HELPBAR_MC_CALL_MENU]          = COMPOUND_STRING("{A_BUTTON}O.K. {B_BUTTON}Zurück"),
    [HELPBAR_MC_CHECK_PAGE]         = COMPOUND_STRING("{B_BUTTON}Zurück"),
    [HELPBAR_RIBBONS_MON_LIST]      = COMPOUND_STRING("{A_BUTTON}Bänder {B_BUTTON}Zurück"),
    [HELPBAR_RIBBONS_LIST]          = COMPOUND_STRING("{A_BUTTON}Prüfen {B_BUTTON}Zurück"),
    [HELPBAR_RIBBONS_CHECK]         = COMPOUND_STRING("{B_BUTTON}Zurück"),
};
