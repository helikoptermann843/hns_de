...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
    ...
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{B_BUTTON}Zurück {R_BUTTON}Fliegen"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{B_BUTTON}Zurück {R_BUTTON}Fliegen"),
#else
    ...
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}Zoom {B_BUTTON}Zurück {R_BUTTON}Fliegen"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}Ganz {B_BUTTON}Zurück {R_BUTTON}Fliegen"),
#endif
