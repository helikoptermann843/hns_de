...
#if IS_HNS
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{B_BUTTON}ABBRUCH"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{B_BUTTON}ABBRUCH"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{B_BUTTON}ABBRUCH {R_BUTTON}FLIEGEN"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{B_BUTTON}ABBRUCH {R_BUTTON}FLIEGEN"),
#else
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}ABBRUCH"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{A_BUTTON}RAUS {B_BUTTON}ABBRUCH"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}ABBRUCH {R_BUTTON}FLIEGEN"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}RAUS {B_BUTTON}ABBRUCH {R_BUTTON}FLIEGEN"),
#endif
    [HELPBAR_CONDITION_MON_LIST]    = COMPOUND_STRING("{A_BUTTON}KONDITION {B_BUTTON}ABBRUCH"),
    [HELPBAR_CONDITION_MON_STATUS]  = COMPOUND_STRING("{A_BUTTON}STATUS {B_BUTTON}ABBRUCH"),
    [HELPBAR_CONDITION_MARKINGS]    = COMPOUND_STRING("{A_BUTTON}SELECT MARK {B_BUTTON}ABBRUCH"),
    [HELPBAR_MC_TRAINER_LIST]       = COMPOUND_STRING("{A_BUTTON}MENÜ {B_BUTTON}ABBRUCH"),
    [HELPBAR_MC_CALL_MENU]          = COMPOUND_STRING("{A_BUTTON}OK {B_BUTTON}ABBRUCH"),
    [HELPBAR_MC_CHECK_PAGE]         = COMPOUND_STRING("{B_BUTTON}ABBRUCH"),
    [HELPBAR_RIBBONS_MON_LIST]      = COMPOUND_STRING("{A_BUTTON}BÄNDER {B_BUTTON}ABBRUCH"),
    [HELPBAR_RIBBONS_LIST]          = COMPOUND_STRING("{A_BUTTON}CHECK {B_BUTTON}ABBRUCH"),
    [HELPBAR_RIBBONS_CHECK]         = COMPOUND_STRING("{B_BUTTON}ABBRUCH"),
};
