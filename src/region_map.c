...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_BATTLE_FRONTIER]   = { 14, 14, 1, 1, COMPOUND_STRING("Kampfzone") },
    ...
    [MAPSEC_VICTORY_ROAD]      = { 16, 4,  1, 4, COMPOUND_STRING("Siegesstraße") },
    ...
    [MAPSEC_MT_MOON]           = { 21, 2,  2, 1, COMPOUND_STRING("Mondberg") },
    [MAPSEC_DIGLETTS_CAVE]     = { 20, 3,  6, 4, COMPOUND_STRING("Digdas Höhle") },
    [MAPSEC_ROCKET_HIDEOUT]    = { 9,  3,  1, 1, COMPOUND_STRING("Rocket-Versteck") },
...
static void TryCreateRedOutlineFlyDestIcons(void)
{
    ...
    for (i = 0; sRedOutlineFlyDestinations[i][1] != MAPSEC_NONE; i++)
    {
        if (FlagGet(sRedOutlineFlyDestinations[i][0]))
        {
            ...
            spriteId = CreateSprite(mapSecId == MAPSEC_MELEMELE_ISLAND ? &sFlyDestIconGreenSpriteTemplate : &sFlyDestIconSpriteTemplate, x, y, 10);
            if (spriteId != MAX_SPRITES)
            {
