...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("Wanderer"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_TEAM_AQUA] = { _("Team Aqua") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN}-Züchter"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("Ass-Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("Vogelfänger"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("{PKMN}-Sammler"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("Schwimmer"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("Team Magma") },
    [TRAINER_CLASS_EXPERT] = { _("Experte"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Vors."), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("Schwarzgurt"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("Aqua Boss"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("Hexe"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("Aromalady"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("Ruinenmaniac"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("Interviewer"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("Planscher"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("Planscher"), 1 },
    [TRAINER_CLASS_LADY] = { _("Lady"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("Schönheit"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("Schnösel"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("Pokémaniac"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("Gitarrist"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("Hitzkopf"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("Camper"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("Picknicker"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("Käfermaniac"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("Psycho"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("Gentleman"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("Top Vier"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("Leiter"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] = { _("Schulkind") },
    [TRAINER_CLASS_SR_AND_JR] = { _("Sen. & Jun."), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("Sihgers,"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("Pokéfan"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("Teenager"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("Champ"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("Angler"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("Triathlet"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Drachenprofi"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("Ninjajunge"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("Kämpferin"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("Schirmdame"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("Schwimmerin"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("Zwil."), 3 },
    [TRAINER_CLASS_SAILOR] = { _("Matrose"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Ass-Trainer"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Magma Vors."), 10 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN}-Trainer"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("Käfersammler"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN}-Ranger"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("Magma Boss"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("Göre"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("Junges Glück"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("Altes Paar"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("Geschwister"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("Kampfkoloss"), 5, BALL_ULTRA },
    ...
    [TRAINER_CLASS_LASS_FRLG] =            { _("Göre"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("Matrose"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("Camper"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("Picknicker"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("Pokémaniac"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("Streber"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("Wanderer"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("Biker"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("Dieb"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("Mechaniker"), 12 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("Angler"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("Schwimmer"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("Glatzkopf"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("Spieler"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("Schönheit"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("Schwimmerin"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("Psycho"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("Rocker"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("Jongleur"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("Dompteur"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("Vogelfänger"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("Schwarzgurt"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("Rivale"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("Forscher"), 12 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("Boss"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("Leiter"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("Team Rocket"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("Ass-Trainer"), 9, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { _("Top Vier"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { _("Gentleman"), 18, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("Rivale"), 9 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("Champ"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("Exorzistin"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("Zwil."), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("Primapaar"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("Junges Glück"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("Mühlensippe"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("Geschwister"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("{PKMN}-Prof."), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("{PKMN}-Trainer"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("Mühlenmädel"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("Planscher"), 1 },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("{PKMN}-Züchter"), 7, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN}-Ranger"), 9 },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("Aromalady"), 7 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("Ruinenmaniac"), 12 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("Lady"), 50 },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("Malerin"), 4 },

    // HnS Trainer Classes
    [TRAINER_CLASS_ARENA_TYCOON_HNS] =     { _("Ringmeister") },
    [TRAINER_CLASS_BATTLE_GIRL_HNS] =      { _("Kämpferin"), 6 },
    [TRAINER_CLASS_BEAUTY_HNS] =           { _("Schönheit"), 20 },
    [TRAINER_CLASS_BIKER_HNS] =            { _("Biker") },
    [TRAINER_CLASS_BIRD_KEEPER_HNS] =      { _("Vogelfänger"), 8 },
    [TRAINER_CLASS_BLACK_BELT_HNS] =       { _("Schwarzgurt"), 8, BALL_ULTRA },
    [TRAINER_CLASS_BUG_CATCHER_HNS] =      { _("Käfersammler"), 4 },
    [TRAINER_CLASS_BURGLAR_HNS] =          { _("Dieb") },
    [TRAINER_CLASS_CAMPER_HNS] =           { _("Camper"), 4 },
    [TRAINER_CLASS_CHAMPION_HNS] =         { _("Champ"), 50, BALL_ULTRA },
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("{PKMN}-Sammler"), 15, BALL_PREMIER },
    [TRAINER_CLASS_COOLTRAINER_HNS] =      { _("Ass-Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("Stadionstar") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("Drachenprofi"), 12 },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("Top Vier"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("Experte"), 10 },
    [TRAINER_CLASS_FACTORY_HEAD_HNS] =     { _("Fabrikleiter") },
    [TRAINER_CLASS_FIREBREATHER_HNS] =     { _("Feuerspucker") },
    [TRAINER_CLASS_FISHERMAN_HNS] =        { _("Angler"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_GENTLEMAN_HNS] =        { _("Gentleman"), 20, BALL_LUXURY },
    [TRAINER_CLASS_GUITARIST_HNS] =        { _("Gitarrist"), 8 },
    [TRAINER_CLASS_HEX_MANIAC_HNS] =       { _("Hexe"), 6 },
    [TRAINER_CLASS_HIKER_HNS] =            { _("Wanderer"), 10 },
    [TRAINER_CLASS_JUGGLER_HNS] =          { _("Jongleur") },
    [TRAINER_CLASS_KIMONO_GIRL_HNS] =      { _("Kimono-Girl") },
    [TRAINER_CLASS_LASS_HNS] =             { _("Göre"), 4 },
    [TRAINER_CLASS_LEADER_HNS] =           { _("Leiter"), 25 },
    [TRAINER_CLASS_LEADER_KANTO_HNS] =     { _("Leiter"), 25 },
    [TRAINER_CLASS_MYSTERY_MAN_HNS] =      { _("Mystiker") },
    [TRAINER_CLASS_OFFICER_HNS] =          { _("Polizist") },
    [TRAINER_CLASS_PALACE_MAVEN_HNS] =     { _("Palastregent") },
    [TRAINER_CLASS_PARASOL_LADY_HNS] =     { _("Schirmdame"), 10 },
    [TRAINER_CLASS_PICNICKER_HNS] =        { _("Picknicker"), 4 },
    [TRAINER_CLASS_PIKE_QUEEN_HNS] =       { _("Pfipitistin") },
    ...
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("Psycho"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("Psycho"), 6 },
    [TRAINER_CLASS_RIVAL_HNS] =            { _("{PKMN}-Trainer"), 15 },
    [TRAINER_CLASS_ROCKET_ADMIN_HNS] =     { _("Rocket-Vors.") },
    [TRAINER_CLASS_SAGE_HNS] =             { _("Weiser") },
    [TRAINER_CLASS_SAILOR_HNS] =           { _("Matrose"), 8 },
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("Kampfkoloss"), 5, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID_HNS] =       { _("Schulkind") },
    [TRAINER_CLASS_SKIER_HNS] =            { _("Skifahrer"), 10 },
    [TRAINER_CLASS_SUPER_NERD_HNS] =       { _("Streber"), 8 },
    [TRAINER_CLASS_SWIMMER_F_HNS] =        { _("Schwimmerin"), 2, BALL_DIVE },
    [TRAINER_CLASS_SWIMMER_M_HNS] =        { _("Schwimmer"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_ROCKET_HNS] =      { _("Team Rocket") },
    [TRAINER_CLASS_TWINS_HNS] =            { _("Zwillinge"), 3 },
    [TRAINER_CLASS_YOUNG_COUPLE_HNS] =     { _("Junges Glück"), 8 },
