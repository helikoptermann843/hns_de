...
{
    // Im offiziellen deutschen Spiel wird "POKéMON" nicht an die Kategorie
    // angehaengt (im dt. Smaragd-Decomp ist dieser Anhang ENGLISH-exklusiv).
    // Angezeigt wird also nur "Samen" statt "Samen Pokémon".
