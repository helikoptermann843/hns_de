const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("Regionalturnier 2003");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("Band des Champs");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("Nationalturnier 2003");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("Weltpokal 2003");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("Band für Platzierungen");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("Band für Halbfinalisten");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("Regionalturnier 2004");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("Nationalturnier 2004");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("Weltpokal 2004");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("Regionalturnier 2005");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("Nationalturnier 2005");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("Weltpokal 2005");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("Pokémon-Kampf-Pokal");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Teilnehmer-Band");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("Pokémon-Liga");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("Talentpokal");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Pokémon-Turnier");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Teilnehmer-Band");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("Pokémon-Wettkampf");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("Pokémon-Festival");
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("Schw.-Grad-Abschl.");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("Gedenk-Band");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("Band für erf. Abschluss");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("aller Schwierigk.-Grade.");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("100. Sieg in Folge");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("Apokelipse-Turm fertig");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("Roter Turm fertig");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("Eiserner Turm fertig");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("Final-Turm-Abschluss");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("Legendäres");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("Pokémon-Center Tokio");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("Pokémon-Center N. Y.");
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("Sommerferien-Band");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("Weihnachtsferien-Band");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("Osterferien-Band");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("Evergreen-Band");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("Sonderurlaubs-Band");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("Fleiß-Band");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("Beliebtheits-Band");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("Energie-Band");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("Ein Gedenk-Band für ein");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("beliebtes Pokémon.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("Ein Band für Pokémon-");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("Freunde.");
