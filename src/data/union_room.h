...
ALIGNED(4) static const u8 sText_AwaitingCommunucation2[] = _("Warte auf die Verbindung\nmit einem Mitspieler."); // Unused
...
static const u8 sText_4PlayersNeeded[] = _("4 Spieler\nnoch.");
...
ALIGNED(4) static const u8 sText_CommunicatingPleaseWait[] = _("Verbindung…\nBitte warten."); // Unused
...
ALIGNED(4) static const u8 sText_ThankYouForRegistering[] = _("Dein Pokémon wurde am Tauschbrett\nzum Tausch angemeldet.\pDanke, dass du diesen Dienst nutzt!\p"); // unused
ALIGNED(4) static const u8 sText_NobodyHasRegistered[] = _("Am Tauschbrett ist zurzeit kein\nPokémon zum Tausch angemeldet.\p\n"); // unused
...
ALIGNED(4) static const u8 sText_TradeTrainersWillBeListed[] = _("Trainer, die tauschen möchten,\nwerden hier aufgeführt."); // unused
...
ALIGNED(4) static const u8 sText_NotRegisteredAMonForTrade[] = _("Du hast kein Pokémon zum Tausch\nangemeldet.\p"); // unused
...
ALIGNED(4) static const u8 sText_PleaseWaitForOtherTrainersToGather[] = _("Warte, bis sich weitere Trainer\neinfinden und bereit sind."); // Unused
