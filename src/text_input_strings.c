...
const u8 gText_NamingScreenKeyboard_ghijkl[] = _("{CLEAR 12}i{CLEAR 7}j{CLEAR 7}k{CLEAR 7}l{CLEAR 21}m{CLEAR 6}n{CLEAR 6}o{CLEAR 6}p{CLEAR 20},");
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 11}q{CLEAR 6}r{CLEAR 7}s{CLEAR 6}t{CLEAR 20}u{CLEAR 6}v{CLEAR 6}w{CLEAR 6}x{CLEAR 20} ");
const u8 gText_NamingScreenKeyboard_tuvwxyz[] = _("{CLEAR 11}y{CLEAR 6}z{CLEAR 6} {CLEAR 6} {CLEAR 26}ä{CLEAR 6}ö{CLEAR 6}ü{CLEAR 6} {CLEAR 20} ");
const u8 gText_NamingScreenKeyboard_ABCDEF[] = _("{CLEAR 11}A{CLEAR 6}B{CLEAR 6}C{CLEAR 6}D{CLEAR 20}E{CLEAR 6}F{CLEAR 6}G{CLEAR 6}H{CLEAR 20}.");
