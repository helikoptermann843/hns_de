...
extern const u32 gBattleEnvironmentTiles_RockSnow[];
extern const u32 gBattleEnvironmentTilemap_RockSnow[];
extern const u32 gBattleEnvironmentAnimTiles_RockSnow[];
extern const u32 gBattleEnvironmentAnimTilemap_RockSnow[];
extern const u16 gBattleEnvironmentPalette_RockSnow[];
extern const u32 gBattleEnvironmentTiles_MountainSnow[];
extern const u32 gBattleEnvironmentTilemap_MountainSnow[];
extern const u32 gBattleEnvironmentAnimTiles_MountainSnow[];
extern const u32 gBattleEnvironmentAnimTilemap_MountainSnow[];
extern const u16 gBattleEnvironmentPalette_MountainSnow[];
...
extern const u32 gBattleEnvironmentAnimTiles_SnowCave[];
extern const u32 gBattleEnvironmentAnimTilemap_SnowCave[];
...
extern const u32 gBattleEnvironmentTiles_BlueBuilding[];
extern const u16 gBattleEnvironmentPalette_BlueBuilding[];
extern const u32 gBattleEnvironmentTilemap_BlueBuilding[];
extern const u32 gBattleEnvironmentAnimTiles_BlueBuilding[];
extern const u32 gBattleEnvironmentAnimTilemap_BlueBuilding[];

// Modern battle environment graphics
extern const u32 gBattleEnvironmentTiles_TallGrassModern[];
extern const u32 gBattleEnvironmentTilemap_TallGrassModern[];
extern const u32 gBattleEnvironmentAnimTiles_TallGrassModern[];
extern const u32 gBattleEnvironmentAnimTilemap_TallGrassModern[];
extern const u16 gBattleEnvironmentPalette_TallGrassModern[];
extern const u32 gBattleEnvironmentTiles_LongGrassModern[];
extern const u32 gBattleEnvironmentTilemap_LongGrassModern[];
extern const u32 gBattleEnvironmentAnimTiles_LongGrassModern[];
extern const u32 gBattleEnvironmentAnimTilemap_LongGrassModern[];
extern const u16 gBattleEnvironmentPalette_LongGrassModern[];
extern const u32 gBattleEnvironmentTiles_SandModern[];
extern const u32 gBattleEnvironmentTilemap_SandModern[];
extern const u32 gBattleEnvironmentAnimTiles_SandModern[];
extern const u32 gBattleEnvironmentAnimTilemap_SandModern[];
extern const u16 gBattleEnvironmentPalette_SandModern[];
extern const u32 gBattleEnvironmentTiles_UnderwaterModern[];
extern const u32 gBattleEnvironmentTilemap_UnderwaterModern[];
extern const u32 gBattleEnvironmentAnimTiles_UnderwaterModern[];
extern const u32 gBattleEnvironmentAnimTilemap_UnderwaterModern[];
extern const u16 gBattleEnvironmentPalette_UnderwaterModern[];
extern const u32 gBattleEnvironmentTiles_WaterModern[];
extern const u32 gBattleEnvironmentTilemap_WaterModern[];
extern const u32 gBattleEnvironmentAnimTiles_WaterModern[];
extern const u32 gBattleEnvironmentAnimTilemap_WaterModern[];
extern const u16 gBattleEnvironmentPalette_WaterModern[];
extern const u32 gBattleEnvironmentTiles_PondWaterModern[];
extern const u32 gBattleEnvironmentTilemap_PondWaterModern[];
extern const u32 gBattleEnvironmentAnimTiles_PondWaterModern[];
extern const u32 gBattleEnvironmentAnimTilemap_PondWaterModern[];
extern const u16 gBattleEnvironmentPalette_PondWaterModern[];
extern const u32 gBattleEnvironmentTiles_RockModern[];
extern const u32 gBattleEnvironmentTilemap_RockModern[];
extern const u32 gBattleEnvironmentAnimTiles_RockModern[];
extern const u32 gBattleEnvironmentAnimTilemap_RockModern[];
extern const u16 gBattleEnvironmentPalette_RockModern[];
extern const u32 gBattleEnvironmentTiles_RockSnowModern[];
extern const u32 gBattleEnvironmentTilemap_RockSnowModern[];
extern const u32 gBattleEnvironmentAnimTiles_RockSnowModern[];
extern const u32 gBattleEnvironmentAnimTilemap_RockSnowModern[];
extern const u16 gBattleEnvironmentPalette_RockSnowModern[];
extern const u32 gBattleEnvironmentTiles_MountainSnowModern[];
extern const u32 gBattleEnvironmentTilemap_MountainSnowModern[];
extern const u32 gBattleEnvironmentAnimTiles_MountainSnowModern[];
extern const u32 gBattleEnvironmentAnimTilemap_MountainSnowModern[];
extern const u16 gBattleEnvironmentPalette_MountainSnowModern[];
extern const u32 gBattleEnvironmentTiles_VolcanoModern[];
extern const u32 gBattleEnvironmentTilemap_VolcanoModern[];
extern const u32 gBattleEnvironmentAnimTiles_VolcanoModern[];
extern const u32 gBattleEnvironmentAnimTilemap_VolcanoModern[];
extern const u16 gBattleEnvironmentPalette_VolcanoModern[];
extern const u32 gBattleEnvironmentTiles_SnowCaveModern[];
extern const u32 gBattleEnvironmentTilemap_SnowCaveModern[];
extern const u32 gBattleEnvironmentAnimTiles_SnowCaveModern[];
extern const u32 gBattleEnvironmentAnimTilemap_SnowCaveModern[];
extern const u16 gBattleEnvironmentPalette_SnowCaveModern[];
extern const u32 gBattleEnvironmentTiles_CaveModern[];
extern const u32 gBattleEnvironmentTilemap_CaveModern[];
extern const u32 gBattleEnvironmentAnimTiles_CaveModern[];
extern const u32 gBattleEnvironmentAnimTilemap_CaveModern[];
extern const u16 gBattleEnvironmentPalette_CaveModern[];
extern const u32 gBattleEnvironmentTiles_BuildingModern[];
extern const u32 gBattleEnvironmentTilemap_BuildingModern[];
extern const u32 gBattleEnvironmentAnimTiles_BuildingModern[];
extern const u32 gBattleEnvironmentAnimTilemap_BuildingModern[];
extern const u16 gBattleEnvironmentPalette_BuildingModern[];
extern const u32 gBattleEnvironmentTiles_PlainModern[];
extern const u32 gBattleEnvironmentTilemap_PlainModern[];
extern const u16 gBattleEnvironmentPalette_PlainModern[];
extern const u32 gBattleEnvironmentTiles_StadiumModern[];
extern const u32 gBattleEnvironmentTilemap_StadiumModern[];
extern const u32 gBattleEnvironmentTiles_SkyModern[];
extern const u32 gBattleEnvironmentTilemap_SkyModern[];
extern const u32 gBattleEnvironmentAnimTiles_SkyModern[];
extern const u32 gBattleEnvironmentAnimTilemap_SkyModern[];
extern const u16 gBattleEnvironmentPalette_SkyModern[];
extern const u32 gBattleEnvironmentTiles_BlueBuildingModern[];
extern const u16 gBattleEnvironmentPalette_BlueBuildingModern[];
extern const u32 gBattleEnvironmentTilemap_BlueBuildingModern[];
extern const u32 gBattleEnvironmentAnimTiles_BlueBuildingModern[];
extern const u32 gBattleEnvironmentAnimTilemap_BlueBuildingModern[];
extern const u16 gBattleEnvironmentPalette_GrayCaveModern[];
extern const u32 gBattleEnvironmentTiles_CaveWaterModern[];
extern const u16 gBattleEnvironmentPalette_CaveWaterModern[];
extern const u32 gBattleEnvironmentTilemap_CaveWaterModern[];
extern const u32 gBattleEnvironmentAnimTiles_CaveWaterModern[];
extern const u32 gBattleEnvironmentAnimTilemap_CaveWaterModern[];
extern const u16 gBattleEnvironmentPalette_GrayCaveWaterModern[];
extern const u16 gBattleEnvironmentPalette_GroudonModern[];
extern const u16 gBattleEnvironmentPalette_KyogreModern[];
extern const u16 gBattleEnvironmentPalette_FrontierModern[];
extern const u16 gBattleEnvironmentPalette_StadiumWill[];
extern const u16 gBattleEnvironmentPalette_StadiumKoga[];
extern const u16 gBattleEnvironmentPalette_StadiumBruno[];
extern const u16 gBattleEnvironmentPalette_StadiumKaren[];
extern const u16 gBattleEnvironmentPalette_StadiumLance[];
extern const u16 gBattleEnvironmentPalette_StadiumLeaderModern[];
extern const u16 gBattleEnvironmentPalette_TallGrassModernMorning[];
extern const u16 gBattleEnvironmentPalette_TallGrassModernNight[];
extern const u16 gBattleEnvironmentPalette_LongGrassModernNight[];
extern const u16 gBattleEnvironmentPalette_SandModernMorning[];
extern const u16 gBattleEnvironmentPalette_SandModernNight[];
extern const u16 gBattleEnvironmentPalette_WaterModernMorning[];
extern const u16 gBattleEnvironmentPalette_WaterModernNight[];
extern const u16 gBattleEnvironmentPalette_PondWaterModernMorning[];
extern const u16 gBattleEnvironmentPalette_PondWaterModernNight[];
extern const u16 gBattleEnvironmentPalette_RockModernMorning[];
extern const u16 gBattleEnvironmentPalette_RockModernNight[];
extern const u16 gBattleEnvironmentPalette_RockSnowModernMorning[];
extern const u16 gBattleEnvironmentPalette_RockSnowModernNight[];
extern const u16 gBattleEnvironmentPalette_MountainSnowModernMorning[];
extern const u16 gBattleEnvironmentPalette_MountainSnowModernNight[];
extern const u16 gBattleEnvironmentPalette_PlainModernNight[];
extern const u16 gBattleEnvironmentPalette_SkyModernNight[];
...
extern const u16 gItemIconPalette_SquirtBottle[];
...
extern const u32 gEnemyMonShadowsSized_GfxGen4[];
extern const u32 gEnemyMonShadowsSized_GfxGen3[];
