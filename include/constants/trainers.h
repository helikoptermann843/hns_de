...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_ARCHER_HNS,
    TRAINER_PIC_FRONT_ARIANA_HNS,
    TRAINER_PIC_FRONT_BIKER_HNS,
    TRAINER_PIC_FRONT_BURGLAR_HNS,
    TRAINER_PIC_FRONT_CHAMPION_LANCE_HNS,
    TRAINER_PIC_FRONT_CYCLING_TRIATHLETE_M_EM_HNS,
    TRAINER_PIC_FRONT_ELITE_FOUR_BRUNO_HNS,
    TRAINER_PIC_FRONT_ELITE_FOUR_KAREN_HNS,
    TRAINER_PIC_FRONT_ELITE_FOUR_KOGA_HNS,
    TRAINER_PIC_FRONT_ELITE_FOUR_WILL_HNS,
    TRAINER_PIC_FRONT_ENGINEER_HNS,
    TRAINER_PIC_FRONT_EUSINE_HNS,
    TRAINER_PIC_FRONT_FIREBREATHER_HNS,
    TRAINER_PIC_FRONT_GIOVANNI_HNS,
    TRAINER_PIC_FRONT_GOLD_HNS,
    TRAINER_PIC_FRONT_JUGGLER_HNS,
    TRAINER_PIC_FRONT_KIMONO_GIRL_HNS,
    TRAINER_PIC_FRONT_KRIS_HNS,
    TRAINER_PIC_FRONT_LEADER_BLAINE_HNS,
    TRAINER_PIC_FRONT_LEADER_BLUE_HNS,
    TRAINER_PIC_FRONT_LEADER_BROCK_HNS,
    TRAINER_PIC_FRONT_LEADER_BUGSY_HNS,
    TRAINER_PIC_FRONT_LEADER_CHUCK_HNS,
    TRAINER_PIC_FRONT_LEADER_CLAIR_HNS,
    TRAINER_PIC_FRONT_LEADER_ERIKA_HNS,
    TRAINER_PIC_FRONT_LEADER_FALKNER_HNS,
    TRAINER_PIC_FRONT_LEADER_JANINE_HNS,
    TRAINER_PIC_FRONT_LEADER_JASMINE_HNS,
    TRAINER_PIC_FRONT_LEADER_LIZA_HNS,
    TRAINER_PIC_FRONT_LEADER_MISTY_HNS,
    TRAINER_PIC_FRONT_LEADER_MORTY_HNS,
    TRAINER_PIC_FRONT_LEADER_PRYCE_HNS,
    TRAINER_PIC_FRONT_LEADER_SABRINA_HNS,
    TRAINER_PIC_FRONT_LEADER_SURGE_HNS,
    TRAINER_PIC_FRONT_LEADER_WHITNEY_HNS,
    TRAINER_PIC_FRONT_NURSE_HNS,
    TRAINER_PIC_FRONT_OFFICER_HNS,
    TRAINER_PIC_FRONT_PETREL_HNS,
    TRAINER_PIC_FRONT_PROTON_HNS,
    TRAINER_PIC_FRONT_PRYCE_2_HNS,
    TRAINER_PIC_FRONT_PSYCHIC_M_HNS,
    TRAINER_PIC_FRONT_RED_HNS,
    TRAINER_PIC_FRONT_ROCKET_GRUNT_F_HNS,
    TRAINER_PIC_FRONT_ROCKET_GRUNT_M_HNS,
    TRAINER_PIC_FRONT_RUNNING_TRIATHLETE_F_HNS,
    TRAINER_PIC_FRONT_RUNNING_TRIATHLETE_FE_HNS,
    TRAINER_PIC_FRONT_SAGE_HNS,
    TRAINER_PIC_FRONT_SAGE_LEADER_HNS,
    TRAINER_PIC_FRONT_SILVER_HNS,
    TRAINER_PIC_FRONT_SKIER_F_HNS,
    TRAINER_PIC_FRONT_SKIER_M_HNS,
    TRAINER_PIC_FRONT_SUPER_NERD_HNS,
    ...
    TRAINER_PIC_BACK_GOLD_HNS,
    TRAINER_PIC_BACK_KRIS_HNS,
    TRAINER_PIC_BACK_LANCE_HNS,
    TRAINER_PIC_BACK_SILVER_HNS,
    TRAINER_PIC_COUNT,
    TRAINER_PIC_BACK_COUNT = (TRAINER_PIC_COUNT - TRAINER_PIC_FRONT_COUNT),
};

#define TRAINER_BACK_PIC_PLAYER_MALE (IS_HNS ? TRAINER_PIC_BACK_GOLD_HNS : IS_FRLG ? TRAINER_PIC_BACK_RED : TRAINER_PIC_BACK_BRENDAN)
#define TRAINER_BACK_PIC_PLAYER_FEMALE (IS_HNS ? TRAINER_PIC_BACK_KRIS_HNS : IS_FRLG ? TRAINER_PIC_BACK_LEAF : TRAINER_PIC_BACK_MAY)
...
#define FACILITY_CLASS_LEADER_FALKNER_HNS    0x79
#define FACILITY_CLASS_LEADER_BUGSY_HNS      0x7A
#define FACILITY_CLASS_LEADER_WHITNEY_HNS    0x7B
#define FACILITY_CLASS_LEADER_MORTY_HNS      0x7C
#define FACILITY_CLASS_LEADER_CHUCK_HNS      0x7D
#define FACILITY_CLASS_LEADER_JASMINE_HNS    0x7E
#define FACILITY_CLASS_LEADER_PRYCE_HNS      0x7F
#define FACILITY_CLASS_LEADER_CLAIR_HNS      0x80
#define FACILITY_CLASS_LEADER_BROCK_HNS      0x81
#define FACILITY_CLASS_LEADER_MISTY_HNS      0x82
#define FACILITY_CLASS_LEADER_LT_SURGE_HNS   0x83
#define FACILITY_CLASS_LEADER_ERIKA_HNS      0x84
#define FACILITY_CLASS_LEADER_JANINE_HNS     0x85
#define FACILITY_CLASS_LEADER_SABRINA_HNS    0x86
#define FACILITY_CLASS_LEADER_BLAINE_HNS     0x87
#define FACILITY_CLASS_LEADER_BLUE_HNS       0x88
#define FACILITY_CLASS_CHAMPION_LANCE_HNS    0x89
#define FACILITY_CLASS_CHAMPION_STEVEN_HNS   0x8A

#define FACILITY_CLASSES_COUNT               0x8B
...
#define FACILITY_CLASS_FIREBREATHER             FACILITY_CLASS_KINDLER
...
enum TrainerClassID
{
    ...
    // HnS Trainer Classes
    TRAINER_CLASS_ARENA_TYCOON_HNS,
    TRAINER_CLASS_BATTLE_GIRL_HNS,
    TRAINER_CLASS_BEAUTY_HNS,
    TRAINER_CLASS_BIKER_HNS,
    TRAINER_CLASS_BIRD_KEEPER_HNS,
    TRAINER_CLASS_BLACK_BELT_HNS,
    TRAINER_CLASS_BUG_CATCHER_HNS,
    TRAINER_CLASS_BURGLAR_HNS,
    ...
    TRAINER_CLASS_EXPERT_HNS,
    TRAINER_CLASS_FACTORY_HEAD_HNS,
    TRAINER_CLASS_FIREBREATHER_HNS,
    TRAINER_CLASS_FISHERMAN_HNS,
    TRAINER_CLASS_GENTLEMAN_HNS,
    TRAINER_CLASS_GUITARIST_HNS,
    TRAINER_CLASS_HEX_MANIAC_HNS,
    TRAINER_CLASS_HIKER_HNS,
    TRAINER_CLASS_JUGGLER_HNS,
    TRAINER_CLASS_KIMONO_GIRL_HNS,
    TRAINER_CLASS_LASS_HNS,
    TRAINER_CLASS_LEADER_HNS,
    TRAINER_CLASS_LEADER_KANTO_HNS,
    TRAINER_CLASS_MYSTERY_MAN_HNS,
    TRAINER_CLASS_OFFICER_HNS,
    TRAINER_CLASS_PALACE_MAVEN_HNS,
    TRAINER_CLASS_PARASOL_LADY_HNS,
    TRAINER_CLASS_PICNICKER_HNS,
    TRAINER_CLASS_PIKE_QUEEN_HNS,
    TRAINER_CLASS_PKMN_TRAINER_1_HNS,
    TRAINER_CLASS_POKEFAN_HNS,
    TRAINER_CLASS_POKEMANIAC_HNS,
    TRAINER_CLASS_PSYCHIC_HNS,
    TRAINER_CLASS_PSYCHIC_M_HNS,
    TRAINER_CLASS_RIVAL_HNS,
    TRAINER_CLASS_ROCKET_ADMIN_HNS,
    TRAINER_CLASS_SAGE_HNS,
    TRAINER_CLASS_SAILOR_HNS,
    TRAINER_CLASS_SALON_MAIDEN_HNS,
    TRAINER_CLASS_SCHOOL_KID_HNS,
    TRAINER_CLASS_SKIER_HNS,
    TRAINER_CLASS_SUPER_NERD_HNS,
    TRAINER_CLASS_SWIMMER_F_HNS,
    TRAINER_CLASS_SWIMMER_M_HNS,
    TRAINER_CLASS_TEAM_ROCKET_HNS,
    TRAINER_CLASS_TWINS_HNS,
    TRAINER_CLASS_YOUNG_COUPLE_HNS,
    TRAINER_CLASS_YOUNGSTER_HNS,
...
// HnS Encounter Music
#define TRAINER_ENCOUNTER_MUSIC_HG_CHAMPION     14
